...
Namespace Tratamiento.Asistencia.Clasificacion.Penal
    Public Class uscFichaPorRegresion
...
#Region "otros"
        Private Sub MostrarControlesFicha()
            ...
            'btnEditClasifOTT.Visible = IIf(Me._uscEscritura Or Me._uscLectura, True, False)

            Select Case _uscPerfilUsuario
                Case Type.Enumeracion.Usuario.EnumDependencia.SistemasInformacion,
                     ...
                     Type.Enumeracion.Usuario.EnumDependencia.TratamientoPenitenciario
                    btnEditClasifOTT.Visible = IIf(Me._uscEscritura Or Me._uscLectura, True, False)
            End Select
...
#Region "listas"
        Public Sub _ListarUsc()
            ...
            .TipoFichaId = 5'ficha por regresion
            }
...
#Region "Accion"
        ...
        Private Sub ANuevo(Codigo As Integer)
            ...
            Dim strMensaje As String = "Desea generar un nuevo registro de clasificación por regresión? "

            If Codigo <= 0 AndAlso Legolas.Configuration.Aplication.MessageBox.Question(strMensaje) <> DialogResult.Yes Then
                Exit Sub
            End If

            Dim f As New frmMantFichPorRegresionPopup
        ...
        Private Sub btnNuevo_Click(sender As Object, e As EventArgs) Handles btnNuevo.Click
            For i As Integer = 0 To dgvGrilla.Rows.Count - 1
                If dgvGrilla.Item("col_estado", i).Value = "PENDIENTE" Or dgvGrilla.Item("col_est_ott", i).Value = "PENDIENTE" Then
        ...
        Private Sub btnReporte_Click(sender As Object, e As EventArgs) Handles btnReporte.Click
            ...
            If dgvGrilla.Item("col_estado", dgvGrilla.CurrentRow.Index).Value <> "FINALIZADO" Then
                Legolas.Configuration.Aplication.MessageBox.Information("La ficha se encuentra pendiente de finalizar.")
                Exit Sub
            End If
        ...
        Private Sub btnEditClasifOTT_Click(sender As Object, e As EventArgs) Handles btnEditClasifOTT.Click
            If dgvGrilla.Rows.Count <= 0 Then Exit Sub

            If ValidarDatosInterno() = False Then Exit Sub

            If dgvGrilla.Item("col_estado", dgvGrilla.CurrentRow.Index).Value <> "FINALIZADO" Then
                Legolas.Configuration.Aplication.MessageBox.Information("La ficha se encuentra pendiente de finalizar por la junta de clasificación.")
                Exit Sub
            End If
