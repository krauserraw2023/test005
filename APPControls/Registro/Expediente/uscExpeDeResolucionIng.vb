...
Namespace Registro.Documento
    Public Class uscExpeDeResolucionIng
        '/*bussiness*/
...
#Region "Propiedades_Parametricas"
        ...
        End Sub
        Public Property Cadenaperpetua() As Boolean
            Get
                Return rbCadenaperpetua.Checked
            End Get
            Set(ByVal value As Boolean)
                rbCadenaperpetua.Checked = value
            End Set
        End Property
        Public Property TotalAnios() As String
            Get
                Return Me.txtAnios.Text
            End Get
            Set(ByVal value As String)
                Me.txtAnios.Text = value
            End Set
        End Property
        Public Property TotalMeses() As String
            Get
                Return Me.txtMeses.Text
            End Get
            Set(ByVal value As String)
                Me.txtMeses.Text = value
            End Set
        End Property
        ...
        Public _TituloPeriodo As String = ""
#End Region
#Region "Propiedades_UserControl"
        ...
        'Public Property _VisiblePanelMantExpediente() As Boolean
        '    Get
        '        Return Me.pnlExpePermisos.Visible
        '    End Get
        '    Set(value As Boolean)
        ...
        '        Me.pnlExpePermisos.Visible = value
        '    End Set
        'End Property
        'Public Property _VisiblePanelMantDelito() As Boolean
        '    Get
        '        Return Me.pnlEscrituraDelito.Visible
        '    End Get
        '    Set(value As Boolean)
        ...
        '        Me.pnlEscrituraDelito.Visible = value
        '    End Set
        'End Property
        'Public Property _VisiblePanelMantAgraviado() As Boolean
        '    Get
        '        Return Me.pnlEscrituraAgrav.Visible
        '    End Get
        '    Set(value As Boolean)
        ...
        '        Me.pnlEscrituraAgrav.Visible = value
        '    End Set
        'End Property
        'Public Property _VisibleBotonEliminarExpediente() As Boolean
        '    Get
        '        Return Me.btnEliminarExp.Visible
        '    End Get
        '    Set(value As Boolean)
        ...
        '        Me.btnEliminarExp.Visible = value
        '    End Set
        'End Property
        'Public Property _VisibleBotonEliminarAgraviado() As Boolean
        '    Get
        '        Return Me.pnlEliminarAgraviado.Visible
        '    End Get
        '    Set(value As Boolean)
        ...
        '        Me.pnlEliminarAgraviado.Visible = value
        '    End Set
        'End Property

        'Public Property _EnabledBotonAgregarExpediente() As Boolean
        '    Get
        '        Return btnAddExp.Enabled
        '    End Get
        '    Set(value As Boolean)
        '        btnAddExp.Enabled = value
        '    End Set
        'End Property

        'Public Property _EnabledBotonEditarExpediente() As Boolean
        '    Get
        '        Return btnEditExpe.Enabled
        '    End Get
        '    Set(value As Boolean)
        '        btnEditExpe.Enabled = value
        '    End Set
        'End Property

        'Public Property _EnabledBotonEliminarExpediente() As Boolean
        '    Get
        '        Return btnEliminarExp.Enabled
        '    End Get
        '    Set(value As Boolean)
        '        btnEliminarExp.Enabled = value
        '    End Set
        'End Property

        'Public Property _EnabledBotonAgregarDelito() As Boolean
        '    Get
        '        Return btnAddDelito.Enabled
        '    End Get
        '    Set(value As Boolean)
        '        btnAddDelito.Enabled = value
        '    End Set
        'End Property

        'Public Property _EnabledBotonEditarDelito() As Boolean
        '    Get
        '        Return btnEditDelito.Enabled
        '    End Get
        '    Set(value As Boolean)
        '        btnEditDelito.Enabled = value
        '    End Set
        'End Property

        'Public Property _EnabledBotonEliminarDelito() As Boolean
        '    Get
        '        Return btnDelDelito.Enabled
        '    End Get
        '    Set(value As Boolean)
        '        btnDelDelito.Enabled = value
        '    End Set
        'End Property

        'Public Property _EnabledBotonAgregarAgraviado() As Boolean
        '    Get
        '        Return btnAddAgrav.Enabled
        '    End Get
        '    Set(value As Boolean)
        '        btnAddAgrav.Enabled = value
        '    End Set
        'End Property

        'Public Property _EnabledBotonEditarAgraviado() As Boolean
        '    Get
        '        Return btnEditAgrav.Enabled
        '    End Get
        '    Set(value As Boolean)
        '        btnEditAgrav.Enabled = value
        '    End Set
        'End Property

        'Public Property _EnabledBotonEliminarAgraviado() As Boolean
        '    Get
        '        Return btnDelAgrav.Enabled
        '    End Get
        '    Set(value As Boolean)
        '        btnDelAgrav.Enabled = value
        '    End Set
        'End Property
#End Region
#Region "Propiedades_Grilla"
        ...
        Public ReadOnly Property grillaIdCentroSalud As Integer
            Get
                Try
...
#Region "Temporal"
        ...
        Public objEntPeriodoCondenaTempoCol As New Entity.Registro.Documento.PeriodoCondenaSentenciaCol
#Region "Temporal_Listar"
...
#Region "Otros"
        ...
        Private Sub Temporal_Grabar_Expediente_Delito_Agraviado(objEntExpedienteCol As Entity.Registro.ExpedienteCol, objEntDelitoCol As Entity.Registro.DelitoCol,
            ...
            For Each objEntExpediente As Entity.Registro.Expediente In objEntExpedienteCol
                ...
                End If
            Next
            ' Dim abc As Integer = objEntAgraviadoTempoColGrilla.Count
            Temporal_ListarExpediente()
...
#Region "Listar"
        ...
        Public Sub _ListarExpediente(DocumentoJudicialID As Integer, Optional ByVal CargarMandDetencionHistorico As Boolean = True,
            ...
            Try
                ...
                Select Case Me._TipoResolucion
                    ...
                    Case Type.Enumeracion.TipoDocJudicial.enumTipoDocumentoJudicial.Detencion,
                         Type.Enumeracion.TipoDocJudicial.enumTipoDocumentoJudicial.DetencionCarceleta,
                    ...
                    Case Type.Enumeracion.TipoDocJudicial.enumTipoDocumentoJudicial.Notas
                        Me.dgwDelito.Columns("col_del_gen_nom").Visible = False

                        If Me._SubTipo = Type.Enumeracion.DocumentoJudicial.enmSubTipoDocumento.ProyeccionVencimientoCondena Then
                            Me.pnlPeriodoCondena.Visible = True
                        End If
                ...
                Else
                    ...
                    CargarPeriodoCondena(DocumentoJudicialID, objEntPeriodoCondenaTempoCol)

                    intReferenciado = 0
                    For Each exp As Entity.Registro.Expediente In objEntExpedienteCol
                        If exp.ExpedienteReferidoID > 0 Then
                            intReferenciado = exp.ExpedienteReferidoID
                    ...
                    'obj.DocJudicialID = Me._DocumentoJudicialID
                    'intReferenciado = (New Bussines.Registro.InternoExpedientePadre).DocumentoReferenciado(obj)
            ...
            End Try
        End Sub
        Private Sub CargarPeriodoCondena(DocumentoJudicialID As Integer, objEntPeriodoCondenaNuevaTempCol As Entity.Registro.Documento.PeriodoCondenaSentenciaCol)
            objEntPerCon = New Entity.Registro.Documento.PeriodoCondenaSentencia
            ...
            End If
            objEntPeriodoCondenaTempoCol = (New Bussines.Registro.Documento.PeriodoCondenaSentencia).Listar_V2(objEntPerCon) 'no es necesario LM
            If objEntPeriodoCondenaTempoCol.Count > 0 And (Me.AuxMotivoId = 124 Or Me.AuxMotivoId = 178) Then
                pnlPeriodoCondena.Visible = True
            End If
            For i As Integer = 0 To objEntPeriodoCondenaTempoCol.Count - 1 'indexar cada expediente
                objEntPeriodoCondenaTempoCol.PeriodoCondenaSentencia(i).PeriodoCondenaItem = i + 1
                txtAnios.Text = objEntPeriodoCondenaTempoCol.PeriodoCondenaSentencia(i).Anio
                txtMeses.Text = objEntPeriodoCondenaTempoCol.PeriodoCondenaSentencia(i).Mes
                txtDias.Text = objEntPeriodoCondenaTempoCol.PeriodoCondenaSentencia(i).Dia
                dtpFechaInicio.ValueLong = objEntPeriodoCondenaTempoCol.PeriodoCondenaSentencia(i).FechaInicio
        ...
        Private Sub listar_PeriodoCondenaNuevo()
            ...
            Next
        End Sub
        Public Sub ActualizarLibertad(LibertadID As Integer, LibertadNom As String)
...
#Region "Accion"
        ...
        Public Sub _Grabar(DocumentoJudicialID As Integer, Nuevo As Boolean, Optional TipoDocumento As Short = -1, Optional MotivoIngresoID As Short = -1)
            EliminarExpedienteBD()
            Select Case Me._TipoLicencia
                Case enmTipoLicencia.Carceleta, enmTipoLicencia.PenalLimaMetropolitana, enmTipoLicencia.RegionLimaMetropolitana
                    AGrabar_LM(DocumentoJudicialID, Nuevo, TipoDocumento, MotivoIngresoID)
                Case Else
                    AGrabar(DocumentoJudicialID, Nuevo, TipoDocumento, MotivoIngresoID)
            End Select
        End Sub

        Private Sub AGrabar_LM(DocumentoJudicialID As Integer, Nuevo As Boolean, Optional TipoDocumento As Short = -1, Optional MotivoIngresoID As Short = -1)
            ...
            Else
                For Each objExpediente As Entity.Registro.Expediente In Me.objEntExpedienteTempoCol
                    ...
                    With objExpediente
                        ...
                        objExpediente.MotivoIngresoID = MotivoIngresoID
                    End With
                    ...
                    If intIdExpe > 0 Then
                        ...
                        If Nuevo = True Then
                            If objExpediente.DocumentoTipoID = enumTipoDocumentoJudicial.AcumulacionExpedientes Or
                               objExpediente.DocumentoTipoID = enumTipoDocumentoJudicial.Refundicion_de_Sentencia Or
                               objExpediente.DocumentoTipoID = enumTipoDocumentoJudicial.Sumatoria_de_Sentencia Or
                                CodDocumentoTipoOrig = enumTipoDocumentoJudicial.AcumulacionExpedientes Then
            ...
            Else
                ...
                End If
            End If
            ''Grabar periodo de condena j.e.u
            GrabarPeridoCondena(DocumentoJudicialID)
        End Sub

        Private Sub AGrabar(DocumentoJudicialID As Integer, Nuevo As Boolean, Optional TipoDocumento As Short = -1, Optional MotivoIngresoID As Short = -1)
            objBssExp = New Bussines.Registro.Expediente
            objBssExpedientePad = New Bussines.Registro.InternoExpedientePadre
            'Recorrer expedientes y grabar
            If Me._TipoResolucion = Type.Enumeracion.TipoDocJudicial.enumTipoDocumentoJudicial.Avocamiento Then
            ...
            Else
                For Each objExpediente As Entity.Registro.Expediente In Me.objEntExpedienteTempoCol
                    ...
                    With objExpediente
                        If Nuevo = True Then
                            If .DocumentoTipoID = enumTipoDocumentoJudicial.AcumulacionExpedientes Or
                               ...
                               .DocumentoTipoID = enumTipoDocumentoJudicial.Sumatoria_de_Sentencia Then
                                ...
                                Next
                            Else
                                If (Me.AuxMotivoId = 116 Or Me.AuxMotivoId = 117 Or Me.AuxMotivoId = 120 Or Me.AuxMotivoId = 197) And objExpediente.Codigo > 0 Then
                                    objExpediente.LibertadTipoID = -1
                                Else
                                    'ocultamos el original
                                    If objExpediente.Codigo > 0 Then objBssExp.GrabarEstadoVisibilidad(objExpediente.Codigo, False, Me.FlagTransferSede)
                                End If
                            End If
                            .DocumentoTipoID = TipoDocumento
                            .Codigo = -1
                        Else
                        ...
                        .FlagTransferenciaSede = Me.FlagTransferSede
                        If Nuevo = False Then
                            If MotivoIngresoID = 178 Or MotivoIngresoID = 179 Then
                                .MotivoIngresoID = MotivoIngresoID
                            Else
                                .MotivoIngresoID = -1
                            End If
                        End If
                        If TipoDocumento = Type.Enumeracion.TipoDocJudicial.enumTipoDocumentoJudicial.Revocatoria_de_Libertad Then
                            .LibertadTipoID = -1
                        End If
                    End With
                    ...
                    If intIdExped > 0 Then
                        ...
                        With objExpediente
                            If .DocumentoTipoID = Type.Enumeracion.TipoDocJudicial.enumTipoDocumentoJudicial.AcumulacionExpedientes Or
                               ...
                               CodDocumentoTipoOrig = Type.Enumeracion.TipoDocJudicial.enumTipoDocumentoJudicial.AcumulacionExpedientes Then
                            ...
                            Else
                                If Nuevo = True Then
                                    If CodExpedienteOrig > 0 Then
                                        objBssExpedientePad.Grabar(objExpedientePad) 'guardar en BD
                                    End If
                                Else
                                    If CodExpedienteOrig > 0 And Not (CodDocumentoOrig = DocumentoJudicialID) Then
                                        objBssExpedientePad.Grabar(objExpedientePad) 'guardar en BD
                                    End If
                                    'If (CodExpedienteOrig <> intIdExped Or (CodExpedienteOrig > 0 And CodDocumentoOrig <> DocumentoJudicialID)) Then
                                    'End If
                                End If
                            End If
                        End With
            ...
            Select Case _TipoResolucion
                Case 15
                    GrabarPeridoCondena(DocumentoJudicialID)
                Case Else
                    Select Case MotivoIngresoID
                        Case 124, 178, 179, 196
                            If Me.Cadenaperpetua = False Then
                                GrabarPeridoCondena(DocumentoJudicialID)
                            Else
                                objBssPerCon = New Bussines.Registro.Documento.PeriodoCondenaSentencia
                                objBssPerCon.EliminarV2(-1, DocumentoJudicialID)
                            End If
                        Case Else
                            If Nuevo = False Then
                                objBssPerCon = New Bussines.Registro.Documento.PeriodoCondenaSentencia
        ...
        Private Sub GrabarPeridoCondena(DocumentoJudicialID As Integer)
            objBssPerCon = New Bussines.Registro.Documento.PeriodoCondenaSentencia
            If objEntPeriodoCondenaTempoCol Is Nothing Then Exit Sub
                ...
                Select Case Me._TipoLicencia
                    ...
                    Case Else
                        If entPerCond.FlgEliminado = True Then
                            If entPerCond.Codigo > 0 Then objBssPerCon.Eliminar(entPerCond.Codigo, Me.FlagTransferSede)
                        Else
                            objBssPerCon.Grabar_V2(entPerCond)
                        End If
                End Select
            Next
            If dtpFechaInicio.ValueLong > 0 Or dtpFechaFinal.ValueLong > 0 Then
                ...
                With entPerCond
                    If objEntPeriodoCondenaTempoCol.Count = 0 Then
                        .Codigo = -1
                    Else
                        .Codigo = objEntPeriodoCondenaTempoCol.PeriodoCondenaSentencia(0).Codigo
                    End If
                    .DocJudicialId = DocumentoJudicialID
                    .InternoId = Me._InternoID
                    .IngresoId = Me._InternoIngresoID
        ...
        Public Function GenerarMovimientoLibertad() As Boolean
            ...
            Dim strMensajeNew As String = "Al registrar esta Resolución, el Sistema ha verificado" + Chr(13) +
                                          "que todos los expedientes se encontraran en libertad." + Chr(13) +
                           "Si hace click en :" + Chr(13) +
                           "[Si] se generara un movimiento de libertad con estado pendiente." + Chr(13) +
                           "[No] el proceso cancelara la operación."
            If Me._DocumentoJudicialID > 0 Then
                If (blnAccionEditar = True Or blnAccionEliminar = True) Or entMov.Codigo < 1 Then
                    If objEntExpedienteTempoCol_Aux2.Count = intContaNuevosLib And blnEdic = True Then
                        If entMov.Codigo < 1 Then
                            ...
                            'RaiseEvent _CargarFormularioMovimientoLibertad(objEntExpedienteTempoCol, objEntExpedienteTempoCol.Expediente(Valor).LibertadTipoID, True)
        ...
        Public OrdenGrabar_ As Boolean = False
            ...
            Select Case Me._TipoResolucion
                Case Type.Enumeracion.DocumentoJudicial.enmTipoDocumento.Ingreso
                    ...
                    If dgwExpediente.RowCount > 0 Then
                        ...
                        Me.idCentroSaludMental = idCentroSaludMental
                    End If
...
#Region "Formularios"
        Private Sub FrmAgregarInimputable(idTipoInimputable As Short, idCentroSaludMental As Short)
            ...
            With frm
                ...
                ._idTipoDocumentoJudicial = Type.Enumeracion.DocumentoJudicial.enmTipoDocumento.Ingreso
        ...
        End Sub
#End Region
#Region "Funciones_Publicas_UserControl"
        Public Sub _mostrarBotonInimputables(idMotivoIngreso As Short)

            Dim blnVerBotonInimputable As Boolean = False

            Select Case idMotivoIngreso
                Case Type.Enumeracion.Movimiento.EnumMovMotivo.Inimputable
                    blnVerBotonInimputable = True
                    btnInimputable2.Visible = False
                    lblEstablecimientomental2.Visible = False
            ...
            If blnVerBotonInimputable = True Then
                ActualizarDatosTipoInimputable(idMotivoIngreso, grillaIdCentroSalud)
            End If
            Me.pnlInimputable.Visible = blnVerBotonInimputable
            Me.btnInimputable.Visible = blnVerBotonInimputable
        End Sub
#End Region
#Region "Otros"
        ...
        Public Function Validar(Suptipo As Short, idMovimientoMotivo As Short) As Boolean
            ...
            End If
            'validar el tipo de inimputable del expediente
            Select Case idMovimientoMotivo
                Case Type.Enumeracion.Movimiento.EnumMovMotivo.Inimputable

                    Dim idCentroSaludMental As Short = dgwExpediente.SelectedRows(0).Cells("col_id_cen_sal_men").Value

                    If idCentroSaludMental < 1 Then
                        Legolas.Configuration.Aplication.MessageBox.Exclamation("Seleccionar un Establecimiento de salud mental ó [NO INDICA]")
                        Return False
                    End If
            End Select
            ...
            If Me._TipoResolucion = Type.Enumeracion.TipoDocJudicial.enumTipoDocumentoJudicial.Ingreso Then
                strMensaje = ""
                If Me.AuxMotivoId = 178 Then 'Inimputable de ingreso
                    If idCentroSaludMental = -1 Then
                        Legolas.Configuration.Aplication.MessageBox.Exclamation("Ingresar el establecimiento de salud mental.")
                        btnInimputable.Focus()
                        Return False
                    End If
                End If
                If Me.rbCadenaperpetua.Checked = False Then
                    Dim blntiempo As Boolean = False
                    Dim blnPeriodo As Boolean = False
                    If (Me.txtAnios.Text.Length = 0 Or Me.txtAnios.Text = "0") And (txtMeses.Text.Length = 0 Or txtMeses.Text = "0") And
                       (Me.txtDias.Text.Length = 0 Or txtDias.Text = "0") Then
                        blntiempo = True
                    End If
                    Dim conEliminado As Integer = 0
                    For i As Integer = 0 To dgvPeriodoCondena.Rows.Count - 1
                        If dgvPeriodoCondena.Item("col_eliminado", i).Value = True Then
                            conEliminado = conEliminado + 1
                        End If
                    Next
                    If Me.dgvPeriodoCondena.Rows.Count = conEliminado Then
                        blnPeriodo = True
                    End If

                    'validar el tiempo de condena
                    If blntiempo = True And blnPeriodo = True Then

                        Select Case idMovimientoMotivo
                            Case Type.Enumeracion.Movimiento.EnumMovMotivo.IngresoSentencia

                                strMensaje = "No ha ingresado la duración de la condena ni el cómputo." + Chr(13) +
                                      "" + Chr(13) + "¿De todas maneras, desea guardar los datos?"
                                txtAnios.Focus()

                            Case Type.Enumeracion.Movimiento.EnumMovMotivo.Inimputable

                                strMensaje = "No ha ingresado la Duración de la medida de seguridad ni el computo de la medida de seguridad." + Chr(13) +
                                             "" + Chr(13) + "¿De todas maneras, desea guardar los datos?"
                                txtAnios.Focus()
                        End Select
                ...
                End If
            ElseIf Me._TipoResolucion = Type.Enumeracion.TipoDocJudicial.enumTipoDocumentoJudicial.Notas Then
                If (Me.txtAnios.Text.Length = 0 Or Me.txtAnios.Text = "0") And (txtMeses.Text.Length = 0 Or txtMeses.Text = "0") _
                    And (txtDias.Text.Length = 0 Or txtDias.Text = "0") Then
                    Legolas.Configuration.Aplication.MessageBox.Exclamation("Ingresar tiempo de condena")
                    txtAnios.Focus()
                    Return False
                End If
                Dim contador = 0
                For Each ent As Entity.Registro.Documento.PeriodoCondenaSentencia In objEntPeriodoCondenaTempoCol
                    If ent.FlgEliminado = False Then
                        contador += 1
                    End If
                Next
                If dtpFechaInicio.ValueLong = 0 And dtpFechaFinal.ValueLong = 0 And contador = 0 Then
                    Legolas.Configuration.Aplication.MessageBox.Exclamation("Ingresar periodo de inicio o fin de condena")
        ...
        Public Function ValidarLibertadV2() As Boolean
            ...
            Return blnCondicionLib
        End Function
        Private AuxMotivoId As Integer = -1
        Public Sub PeriodoCondenaVisible(DocumentoTipo As Integer, MotivoId As Integer)

            If DocumentoTipo = Type.Enumeracion.TipoDocJudicial.enumTipoDocumentoJudicial.Ingreso Then

                If MotivoId = Type.Enumeracion.Movimiento.EnumMovMotivo.IngresoSentencia Or
                   MotivoId = Type.Enumeracion.Movimiento.EnumMovMotivo.Adelanto_de_fallo Then

                    pnlPeriodoCondena.Visible = True
                    gbDuracioncondena.Text = "Duración de la condena"
                    gbComputo.Text = "Cómputo"
                    Me._TituloPeriodo = gbComputo.Text
                    If MotivoId <> AuxMotivoId Then
                        Me.txtAnios.Text = 0
                        Me.txtMeses.Text = 0
                        Me.txtDias.Text = 0
                    End If

                ElseIf MotivoId = Type.Enumeracion.Movimiento.EnumMovMotivo.Inimputable Then

                    pnlPeriodoCondena.Visible = True
                    gbDuracioncondena.Text = "Duración de la medida de seguridad"
                    gbComputo.Text = "Cómputo de la medida de seguridad"
                    Me._TituloPeriodo = gbComputo.Text
                    ...
                    End If
                Else
                    pnlPeriodoCondena.Visible = False
                End If

                AuxMotivoId = MotivoId
            End If
        End Sub
        Public Sub PeriodoCondenaVisible(blnValor As Boolean)
            pnlPeriodoCondena.Visible = blnValor
            If blnValor = True Then
                gbDuracioncondena.Text = "Duración de la medida de seguridad"
                gbComputo.Text = "Cómputo de la medida de seguridad"
            Else
...
#End Region
        ...
        Private Sub btnDelExp_Click(sender As System.Object, e As System.EventArgs)
            If dgwExpediente.Rows.Count = 0 Then
        ...
        Private Sub uscExpeDeResolucion_Load(sender As Object, e As System.EventArgs) Handles Me.Load
            ...
            If Me._TipoResolucion = enumTipoDocumentoJudicial.Detencion Or Me._TipoResolucion = enumTipoDocumentoJudicial.DetencionReferenciado Or Me._TipoResolucion = enumTipoDocumentoJudicial.DetencionCarceleta Then
                Me.pnlCabExpediente.Visible = False
                Me.dgwExpediente.Visible = False
            End If
        ...
        Private Sub dgwExpediente_KeyUp(sender As Object, e As System.Windows.Forms.KeyEventArgs)
            If dgwExpediente.Rows.Count > 0 Then
        ...
        Private Sub dgwExpediente_CellClick(sender As Object, e As System.Windows.Forms.DataGridViewCellEventArgs)
            ...
            End If
        End Sub
        Private Sub dgwExpediente_CellContentClick(sender As Object, e As System.Windows.Forms.DataGridViewCellEventArgs)
            dgwExpediente_CellClick(Nothing, Nothing)
        ...
        Private Sub btnEditPerCond_Click(sender As Object, e As EventArgs) Handles btnEditPerCond.Click
            ...
            Try
                ...
                If Not dgvPeriodoCondena.CurrentRow Is Nothing Then
                    intIndice = dgvPeriodoCondena.CurrentRow.Index
                    RaiseEvent _Click_PeriodoCondena_Editar(objEntPeriodoCondenaTempoCol.PeriodoCondenaSentencia(intIndice))
                Else
        ...
        Private Sub dgvPeriodoCondena_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgvPeriodoCondena.CellContentClick

        End Sub

        Private Sub dgvPeriodoCondena_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgvPeriodoCondena.CellDoubleClick
        ...
        Private Sub dgwExpediente_DoubleClick(sender As Object, e As EventArgs) Handles dgwExpediente.DoubleClick
            'btnEditExpe.PerformClick()
        End Sub

        Private Sub dgwExpediente_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgwExpediente.CellDoubleClick
            ' btnEditExpe.PerformClick()
        ...
        Private Sub rbTemporal_CheckedChanged(sender As Object, e As EventArgs) Handles rbTemporal.CheckedChanged, rbCadenaperpetua.CheckedChanged
            If rbTemporal.Checked = True Then
                ...
                Me.dtpFechaInicio.ValueLong = 0
                Me.dtpFechaFinal.ValueLong = 0
                Me.txtAnios.Focus()
            End If
            ...
            End If
        End Sub
        Dim idCentroSaludMental As Short = -1
        Private Sub btnInimputable_Click(sender As Object, e As EventArgs) Handles btnInimputable.Click
            ...
            idCentroSaludMental = dgwExpediente.SelectedRows(0).Cells("col_id_cen_sal_men").Value

            FrmAgregarInimputable(idTipoInimputable, idCentroSaludMental)

        End Sub

        Private Sub btnEliminarExp_Click(sender As Object, e As EventArgs) Handles btnEliminarExp.Click
