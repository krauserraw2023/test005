...
Namespace Registro.Identificacion.v5
    Public Class uscGrilletes
        Public Event _ClickAdd()
        Public Event _ClickMod(AliasID As Integer, IngresoID As Integer)
        Public Event _DoubleClick(AliasID As Integer, IngresoID As Integer)
        ...
        Public Sub _Load()
            ...
            Select Case Me.TipoLicencia
                ...
                Case Else
                    ...
                    col_ing_nro_inpe.Visible = False
            End Select
            btnAddGrilletes.Visible = True
            btnModGrilletes.Visible = True
            btnEliGrilletes.Visible = True
...
#End Region
        ...
        Private Sub dgwAlias_CellDoubleClick(sender As Object, e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgwGrillete.CellDoubleClick
            If Me.dgwGrillete.RowCount > 0 Then
                If (Me.TipoLicencia = enmTipoLicencia.Carceleta _
                   Or Me.TipoLicencia = enmTipoLicencia.PenalLimaMetropolitana _
                   Or Me.TipoLicencia = enmTipoLicencia.RegionLimaMetropolitana) Then
                    RaiseEvent _DoubleClick(Me.GrillaAliasCodigo, -1)
                Else
                    RaiseEvent _DoubleClick(Me.GrillaAliasCodigo, Me.GrillaAliasIngreso)
                End If
            End If
        End Sub
        ...
        Private Sub dgwAlias_KeyDown(sender As Object, e As System.Windows.Forms.KeyEventArgs) Handles dgwGrillete.KeyDown
            If e.KeyCode = Keys.Delete Then
                btnEliAlias_Click(sender, e)
            End If
        End Sub

        Private Sub btnModAlias_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnModGrilletes.Click
            If dgwGrillete.Rows.Count > 0 Then
                If (Me.TipoLicencia = enmTipoLicencia.Carceleta _
                   Or Me.TipoLicencia = enmTipoLicencia.PenalLimaMetropolitana _
                   Or Me.TipoLicencia = enmTipoLicencia.RegionLimaMetropolitana) Then
                    RaiseEvent _ClickMod(Me.GrillaAliasCodigo, -1)
                Else
                    RaiseEvent _ClickMod(Me.GrillaAliasCodigo, Me.GrillaAliasIngreso)
                End If
            Else
        ...
        Private Sub btnAddAlias_Click(sender As System.Object, e As System.EventArgs) Handles btnAddGrilletes.Click
            RaiseEvent _ClickAdd()
        End Sub

        Private Sub btnEliAlias_Click(sender As System.Object, e As System.EventArgs) Handles btnEliGrilletes.Click
            If dgwGrillete.Rows.Count > 0 Then
                AEliminarAlia()
            Else
