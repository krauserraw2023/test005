...
Namespace Registro.Reniec
    Public Class uscValidacionDatosReniecV2
                ...
                Try
                    ...
                    Select Case intTipoLocal
                        Case 2 'solo para regiones 
                            objImagenByte = ObjBss.getArchivoDigitalByte_Region(ArchivoDigitalID, 4, strMensajeError) 'reniec
                        Case Else
                            'penales y sede
                            r = objWS.ListarArchivoDigital(ArchivoDigitalID, 4) 'reniec
