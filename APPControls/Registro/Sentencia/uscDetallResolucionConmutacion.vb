...
Namespace Registro.Sentencia
    Public Class uscDetallResolucionConmutacion
        '/*bussiness*/
...
#Region "Eventos"
        ...
        Public Event _Click_PeriodoHistorico_Agregar(nuevo As Boolean, objEnt As Entity.Registro.Documento.PeriodoCondenaSentencia)
        Public Event _Click_PeriodoHistorico_Editar(objEnt As Entity.Registro.Documento.PeriodoCondenaSentencia)
#End Region
#Region "Propiedades"
...
#Region "Propiedades_Grilla"
        ...
        Private ReadOnly Property GrillaPeriodoCondenaItem_() As Integer
            ...
            End Get
        End Property
        Private ReadOnly Property GrillaPeriodoHistoricoItem() As Integer
            Get
                Try
                    Return dgvPeriodoCondena.SelectedRows(0).Cells("col_ped_cond_item_").Value
                Catch ex As Exception
                    Return -1
                End Try
            End Get
...
#Region "Temporales"
        ...
        Private Sub Temporal_GrabarPeriodoCondenaNuevo(objEnt As Entity.Registro.Documento.PeriodoCondenaSentencia)
            ...
            Else
                ...
                End If
            End If
            listar_PeriodoCondenaNuevo(objEntPeriodoCondenaNuevaTempoCol)
        End Sub
        ...
        Private Sub listar_PeriodoCondena()
            ...
            If objEntPeriodoCondenaTempoCol.Count > 0 Then
                btnAddPerHis.BackgroundImage = APPControls.My.Resources.Resources._1277961326_folder_edit
            End If

        End Sub

        Private Sub listar_PeriodoCondenaNuevo(objentPeriodoCol As Entity.Registro.Documento.PeriodoCondenaSentenciaCol)
            If objentPeriodoCol Is Nothing Then
                objentPeriodoCol = New Entity.Registro.Documento.PeriodoCondenaSentenciaCol
            End If
            Dim objPeriodoCol As New Entity.Registro.Documento.PeriodoCondenaSentenciaCol
            For Each obj As Entity.Registro.Documento.PeriodoCondenaSentencia In objentPeriodoCol
                If obj.Tipo = 1 Then
                    objPeriodoCol.Add(obj)
                End If
            Next
            With dgvPeriodoCondNueva
                ...
                .AllowUserToResizeRows = False
                .AutoGenerateColumns = False
                .DataSource = IIf(objPeriodoCol.Count = 0, Nothing, objPeriodoCol)
            End With
            ...
            Else
                ...
                For Each objDel As Entity.Registro.Delito In objEntDelitoTempoColGrilla
                    ...
                    For Each objAgr As Entity.Registro.Agraviado In objEntAgraviadoTempoColGrilla
                        ...
                        If Me._DocumentoJudicialID < 1 Then
                            f.Cells("col_tip_reso_id").Value = -1 ' objAgr.TipoResolucionId
...
#Region "Listar"
        ...
        Public Sub _ListarExpediente(DocumentoJudicialID As Integer, Optional ByVal CargarMandDetencionHistorico As Boolean = True,
            ...
            End If
            objEntPerCon.Tipo = -1
            Dim objEntPeriodoCondenaActualTempoCol As New Entity.Registro.Documento.PeriodoCondenaSentenciaCol
            objEntPeriodoCondenaNuevaTempoCol = (New Bussines.Registro.Documento.PeriodoCondenaSentencia).Listar_V2(objEntPerCon) 'no es necesario LM
            Dim ind As Integer = -1
            For i As Integer = 0 To objEntPeriodoCondenaNuevaTempoCol.Count - 1 'indexar cada expediente
                If objEntPeriodoCondenaNuevaTempoCol.PeriodoCondenaSentencia(i).Tipo = 1 Then
                    ind += 1
                    objEntPeriodoCondenaActualTempoCol.Add(objEntPeriodoCondenaNuevaTempoCol.PeriodoCondenaSentencia(i))
                    objEntPeriodoCondenaActualTempoCol.PeriodoCondenaSentencia(ind).PeriodoCondenaItem = ind + 1
                    Me._TotalAnhos = objEntPeriodoCondenaNuevaTempoCol.PeriodoCondenaSentencia(i).Anio
                    Me._TotalMes = objEntPeriodoCondenaNuevaTempoCol.PeriodoCondenaSentencia(i).Mes
                    Me._TotalDias = objEntPeriodoCondenaNuevaTempoCol.PeriodoCondenaSentencia(i).Dia
                End If
            Next
            If Me._TotalAnhos.Length = 0 And Me._TotalMes.Length = 0 And Me._TotalMes.Length = 0 Then
                'If Me._TotalAnhos = 0 And Me._TotalMes = 0 And Me._TotalMes = 0 Then
                objEnt = New Entity.Registro.DocumentoJudicial
                    objBss = New Bussines.Registro.DocumentoJudicial
                    objEnt.Codigo = DocumentoJudicialID
                    Select Case Me._TipoLicencia
                        Case Type.Enumeracion.Licencia.enmTipoLicencia.RegionLimaMetropolitana, Type.Enumeracion.Licencia.enmTipoLicencia.PenalLimaMetropolitana, Type.Enumeracion.Licencia.enmTipoLicencia.Carceleta
                ...
                'End If
            End If
                listar_PeriodoCondenaNuevo(objEntPeriodoCondenaActualTempoCol)
            ''<-----------Periodo de condena anterior---------------------------------------------------------------
            ind = -1
            For i As Integer = 0 To objEntPeriodoCondenaNuevaTempoCol.Count - 1 'indexar cada expediente
                If objEntPeriodoCondenaNuevaTempoCol.PeriodoCondenaSentencia(i).Tipo = 0 Then
                    ind += 1
                    objEntPeriodoCondenaTempoCol.Add(objEntPeriodoCondenaNuevaTempoCol.PeriodoCondenaSentencia(i))
                    objEntPeriodoCondenaTempoCol.PeriodoCondenaSentencia(ind).PeriodoCondenaItem = ind + 1
                    Me.txtAnios2.Text = objEntPeriodoCondenaNuevaTempoCol.PeriodoCondenaSentencia(i).Anio
                    Me.txtMeses2.Text = objEntPeriodoCondenaNuevaTempoCol.PeriodoCondenaSentencia(i).Mes
                    Me.txtDias2.Text = objEntPeriodoCondenaNuevaTempoCol.PeriodoCondenaSentencia(i).Dia
                End If
            Next
            If Not (objEntExpedienteColTmp.Expediente(0) Is Nothing) Then
                ...
                If objEntPerCon.DocJudicialId > 0 Then
                    ...
                    End If
                End If
                If txtAnios2.TextLength = 0 And txtMeses2.TextLength = 0 And txtDias2.TextLength = 0 Then
...
#Region "Accion"
        ...
        Private Sub AGrabar(DocumentoJudicialID As Integer, Nuevo As Boolean, EntDocJud As Entity.Registro.DocumentoJudicial)
            ...
            For Each entPerCond As Entity.Registro.Documento.PeriodoCondenaSentencia In objEntPeriodoCondenaNuevaTempoCol
                With entPerCond
                    ...
                    .Tipo = 1
                    .Anio = IIf(txtAnios.TextLength = 0, 0, Me.txtAnios.Text)
                    .Mes = IIf(txtMeses.TextLength = 0, 0, Me.txtMeses.Text)
                    .Dia = IIf(txtDias.TextLength = 0, 0, txtDias.Text)
                End With
                Select Case Me._TipoLicencia
            ...
            For Each entPerCond As Entity.Registro.Documento.PeriodoCondenaSentencia In objEntPeriodoCondenaTempoCol
                With entPerCond
                    .Codigo = IIf(Nuevo = True, -1, .Codigo)
                    .DocJudicialId = DocumentoJudicialID
                    .InternoId = Me._InternoId
                    .IngresoId = Me._InternoIngresoId
                    .IngresoInpeId = Me._InternoIngresoInpeId
                    .FlagTransferenciaSede = Me.FlagTransferSede
                    .Tipo = 0
                    .Anio = IIf(txtAnios2.TextLength = 0, 0, Me.txtAnios2.Text)
                    .Mes = IIf(txtMeses2.TextLength = 0, 0, Me.txtMeses2.Text)
                    .Dia = IIf(txtDias2.TextLength = 0, 0, Me.txtDias2.Text)
                End With
                Select Case Me._TipoLicencia
                    Case Type.Enumeracion.Licencia.enmTipoLicencia.PenalLimaMetropolitana, Type.Enumeracion.Licencia.enmTipoLicencia.RegionLimaMetropolitana, Type.Enumeracion.Licencia.enmTipoLicencia.Carceleta
                        If entPerCond.FlgEliminado = True Then
        ...
        Public Function Validar() As Boolean
            ...
            Else
                ...
                End If
            End If
            If blnValorDgv = True Then
                Legolas.Configuration.Aplication.MessageBox.Exclamation("Ingresar vencimiento de la pena")
                btnAddPerCond.Focus()
                Return False
            End If
...
#End Region
        ...
        Private Sub dgwExpediente_CellClick(sender As Object, e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgwExpediente.CellClick
            If dgwExpediente.Rows.Count > 0 Then
                Temporal_ListarDelitos(Me.objEntExpedienteTempoCol.Item(Me.GrillaExpedienteIndex))
            End If
        End Sub
        ...
        Private Sub btnEditExpe_Click(sender As System.Object, e As System.EventArgs) Handles btnEditExpe.Click
            ...
            RaiseEvent _Click_Expediente_Editar(Me.objEntExpedienteTempoCol.Expediente(Me.GrillaExpedienteIndex))
        End Sub
        ...
        Private Sub btnAddAgrav_Click(sender As System.Object, e As System.EventArgs) Handles btnAddAgrav.Click
            ...
            If objEntDelitoTempoColGrilla Is Nothing Then
                objEntDelitoTempoColGrilla = New Entity.Registro.DelitoCol
            End If
            RaiseEvent _Click_Delito_Agregar(objEntExpedienteTempoCol.Item(Me.GrillaExpedienteIndex), objEntDelitoTempoColGrilla)
            bolEdicionActivo = True
        End Sub
        ...
        Private Sub dgvPeriodoCondNueva_KeyDown(sender As Object, e As System.Windows.Forms.KeyEventArgs)
            If e.KeyCode = Keys.Delete Then
        ...
        Private Sub btnAddPerCond_Click(sender As System.Object, e As System.EventArgs) Handles btnAddPerCond.Click
            ...
            For i As Integer = 0 To dgvPeriodoCondNueva.Rows.Count - 1
                ...
                End If
            Next
            If Valorfalse > 0 Then
                Legolas.Configuration.Aplication.MessageBox.Exclamation("Solo se registra una fecha de vencimiento de pena")
                Exit Sub
            End If
        ...
        Private Sub lblTituloFecha_Click(sender As Object, e As EventArgs)
        End Sub
        ...
        Private Sub btnAddPerHis_Click(sender As Object, e As EventArgs) Handles btnAddPerHis.Click
            If dgvPeriodoCondena.Rows.Count = 0 Then
                RaiseEvent _Click_PeriodoHistorico_Agregar(True, Nothing)
            Else
                ...
                If dgvPeriodoCondena.CurrentRow Is Nothing Then
                    ...
                    Exit Sub
                End If
                RaiseEvent _Click_PeriodoHistorico_Agregar(False,objEntPeriodoCondenaTempoCol.PeriodoCondenaSentencia(dgvPeriodoCondena.SelectedRows(0).Index))
            End If
        End Sub

        Private Sub dgvPeriodoCondena_DoubleClick(sender As Object, e As EventArgs) Handles dgvPeriodoCondena.DoubleClick
            RaiseEvent _Click_PeriodoHistorico_Editar(objEntPeriodoCondenaTempoCol.PeriodoCondenaSentencia(dgvPeriodoCondena.SelectedRows(0).Index))
        End Sub

        Private Sub btnDelPerHis_Click(sender As Object, e As EventArgs) Handles btnDelPerHis.Click
            If dgvPeriodoCondena.Rows.Count < 1 Then
                Legolas.Configuration.Aplication.MessageBox.Exclamation("Seleccionar periodo de condena para eliminar")
                btnAddPerCond.Focus()
                Exit Sub
            ...
            If Legolas.Configuration.Aplication.MessageBox.Question("¿Esta Seguro de eliminar el periodo de condena seleccionado?") = Windows.Forms.DialogResult.Yes Then
                For i As Integer = 0 To objEntPeriodoCondenaTempoCol.Count - 1
                    If Me.GrillaPeriodoHistoricoItem = objEntPeriodoCondenaTempoCol.PeriodoCondenaSentencia(i).PeriodoCondenaItem Then
