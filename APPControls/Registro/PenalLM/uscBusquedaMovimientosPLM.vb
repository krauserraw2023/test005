Namespace Registro.PenalLM
    Public Class uscBusquedaMovimientosPLM
...
#Region "Funciones_Publicas"
        ...
        Public Sub _Limpiar()
            ...
            Me.cbbMovimientomotivo.Enabled = True
        ...
        Public Sub _Buscar(Optional blnMostrarAlertaRegNoEncontrado As Boolean = True, Optional buscarRegConFechaHoy As Boolean = False)
            ...
            objEntCol = objBss.ListarGrillaMovimientoPLM(objEntFiltro)
            ...
            If blnMostrarAlertaRegNoEncontrado = True And objEntCol.Count = 0 Then
...
#Region "Funciones"
        ...
        Private Function ValidarBusqueda() As Boolean
            ...
            If Me._IDRegion < 1 Then
                ...
                'validar motivo de movimiento
                If Me.IDTipoMotivo < 1 Then
                    strMensaje = "Seleccione un tipo de motivo, para realizar la busqueda"
                    Legolas.Configuration.Aplication.MessageBox.Exclamation(strMensaje)
                    Return value
                End If
            ...
            If cargoComboMovimientoTipo = True Then
                ...
                Select Case Me.IDTipoMovimiento
                    Case Type.Enumeracion.Movimiento.EnumMovTipo.Fuga, Type.Enumeracion.Movimiento.EnumMovTipo.Fallecimiento
                        Me.cbbMovimientomotivo.Enabled = False
                    Case Else
                        Me.cbbMovimientomotivo.Enabled = True
                End Select
