...
#Region "Propiedades_Return"
        Public Property _EnabledPabellon() As Boolean
            Get
                Return Me.grbPabellon.Enabled
            End Get
            Set(value As Boolean)
                Me.grbPabellon.Enabled = value
            End Set
        End Property
#End Region
#Region "Combo"
...
#Region "Accion"
        ...
        Private Sub AOK()
            ...
            With frm
                ...
                ._Filtro.PabellonID = Me.PabellonID
...
#Region "Otros"
        Private Sub HabilitarReporte()
            ...
            Dim blnEnabledEstado As Boolean = False
            Dim blnEnabledInternoGrupo As Boolean = False

            Select Case Me.GrillaCodigo
                Case 14 'Visitas autorizados por el Interno(a)
                    blnEnabledEstado = True
                    blnEnabledInternoGrupo = True
                Case 18 'Visitas autorizados Anexo 02
                    Me.Estado = 1
                    blnEnabledEstado = False
                    blnEnabledInternoGrupo = True
            ...
            If _EnabledTipoInterno = False Then
                blnEnabledInternoGrupo = _EnabledTipoInterno
            End If

            Me.grbEstado.Enabled = blnEnabledEstado
            Me.grbInterno.Enabled = blnEnabledInternoGrupo
        ...
        Private Sub ValoresxDefault()
            ...
            Me.grbInterno.Enabled = Me._EnabledTipoInterno
