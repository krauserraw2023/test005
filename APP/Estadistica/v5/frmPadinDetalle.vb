                ...
                Try
                    Select Case TipoGrilla
                        ...
                        Case enmTipoGrilla.Padin
                            ...
                            'Case enmTipoGrilla.PadinOrdenado

                            '    With Me.dgwGrillaPadin
                            '        value = .SelectedRows(0).Cells("col_obs_reg_pad").Value
                            '    End With
...
#Region "Listar"
        Private Sub Listar()
            ...
            ContadoresGrilla(enmTipoGrilla.PoblacionActica)

            Me.lblFiltro.Text = "Reg. filtrados : " & dgwGrillaPoblacionActiva.RowCount
        ...
        Private Sub ListarPoblacionActiva()
            ...
            If objEntColActivos.Count = 0 Then
                ...
                objEntColActivos = objBss.ListarPoblacionActiva(objEntFiltro)
        ...
        Private Sub ListarPadin()
            ...
            If blnCargoDataPadin = False Then
                ...
                For Each obj As Entity.Estadistica.PadinDetalle In objEntColIngresos
                    objEntColPadin.Add(obj) 'insertando filas  a padin
                Next
                    ...
                    For Each obj2 As Entity.Estadistica.PadinDetalle In objEntColPadin
                        If obj.InternoID = obj2.InternoID Then
                            If obj.IngresoID = obj2.IngresoID And obj.FechaIngresoPenal = obj2.FechaIngresoPenal Then
                                ...
                                obj2.EgresoTipoMotivoID = obj.EgresoTipoMotivoID
                                ...
                                obj2.EgresoObservacion = obj.EgresoObservacion
            ...
            objEntGrillaCol = ListarFiltro(objEntColPadin)
            ...
            '    .CurrentCell = Nothing
            'End With
            'Me.dgwGrillaPadin.Columns("col_pad_pen_cod").Visible = True
        End Sub
        ...
        Private Sub ContadoresGrilla(TipoGrilla As enmTipoGrilla)
            ...
            Select Case TipoGrilla
                Case enmTipoGrilla.PoblacionActica
                    ...
                    strCount = "Tot. de ingresos nuevos : " & CountInternoNuevos & " / "
            ...
            Me.lblReg.Text = strCount & "Reg. con obs. Activos : " & CountObsActivos & " / Reg. con obs. Padin : " & CountObsPadin
...
#End Region
        ...
        Private Sub btnExportar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnExportar.Click
            ...
            Me.col_img_obs_regLA.Visible = False
            Me.col_img_obs_reg.Visible = False

            Me.col_img_obs_regLI.Visible = False
            Me.col_img_obs_regLE.Visible = False

            Select Case TabControl1.SelectedIndex
                Case 0
                    Legolas.Components.ExportarGrillaExcel.Exportar(Me.dgwGrillaPoblacionActiva)
                Case 1
                    Legolas.Components.ExportarGrillaExcel.Exportar(Me.dgwGrillaIngresos)
                Case 2
                    Legolas.Components.ExportarGrillaExcel.Exportar(Me.dgwGrillaEgresos)
                Case 3
                    Legolas.Components.ExportarGrillaExcel.Exportar(Me.dgwGrilla)
            End Select

            Me.col_img_obs_regLA.Visible = True
            Me.col_img_obs_reg.Visible = True

            Me.col_img_obs_regLI.Visible = True
            Me.col_img_obs_regLE.Visible = True
        ...
        End Sub
        Private Sub dgwGrillaPoblacionActiva_CellClick(sender As Object, e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgwGrillaPoblacionActiva.CellClick

            With Me.dgwGrillaPoblacionActiva
                If .Columns(e.ColumnIndex).Name = "col_img_obs_regLA" And e.RowIndex = -1 Then Exit Sub
                ...
                If e.RowIndex >= 0 Then
                    If .Columns(e.ColumnIndex).Name = "col_img_obs_regLA" Then
                        FRM_MensajePadin(Me.GrillaObservacion(enmTipoGrilla.PoblacionActica))
                    End If
                End If
        ...
        Private Sub dgwGrilla_CellFormatting(sender As Object, e As System.Windows.Forms.DataGridViewCellFormattingEventArgs) Handles dgwGrilla.CellFormatting
            ...
            With Me.dgwGrilla
                Select Case e.ColumnIndex
                    ...
                    .Columns("col_fec_ing_pen").Index,
                    .Columns("col_fec_sen").Index,
                    .Columns("col_fec_ini").Index,
                    .Columns("col_fec_fin").Index,
        ...
        Private Sub dgwGrillaPoblacionActiva_CellFormatting(sender As Object, e As System.Windows.Forms.DataGridViewCellFormattingEventArgs) Handles dgwGrillaPoblacionActiva.CellFormatting
        ...
        Private Sub dgwGrillaPoblacionActiva_CellPainting(sender As Object, e As System.Windows.Forms.DataGridViewCellPaintingEventArgs) Handles dgwGrillaPoblacionActiva.CellPainting
            If e.RowIndex = -1 Or e.ColumnIndex = -1 Then Exit Sub
        ...
        Private Sub dgwGrillaPoblacionActiva_CellEnter(sender As Object, e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgwGrillaPoblacionActiva.CellEnter
        ...
        Private Sub btnDetalleInterno_Click(sender As System.Object, e As System.EventArgs) Handles btnDetalleInterno.Click
            ...
            Select Case indice
                Case 0 'lista activos
                    intIDInterno = Me.GrillaIDInterno(enmTipoGrilla.PoblacionActica)
                Case 1 'ingresos
