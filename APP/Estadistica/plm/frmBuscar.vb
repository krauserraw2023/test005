...
#Region "Listar"
        Private Sub Listar()
            ...
            objEntCol = objBss.Listar(-1, Me.IDRegion, Me.PenalID, Me.Anio, Me.Mes, Me.Estado, Me.FechaCorte)
...
#Region "Accion"
        ...
        Private Function Leer_Reg_Seleccionadas(ByVal dgw As DataGridView) As Dictionary(Of Integer, Integer)
            ...
            For Each fila As DataGridViewRow In dgw.Rows
                ...
                If seleccionado Then lstInteger.Add(fila.Cells("col_id").Value, fila.Cells("col_pad_ver").Value)
            Next

            If lstInteger.Count = 0 Then lstInteger.Add(dgw.Item("col_id", dgw.CurrentCell.RowIndex).Value, dgw.Item("col_pad_ver", dgw.CurrentCell.RowIndex).Value)
...
#Region "Form"
        ...
        Private Sub FRM_Mantenimiento(ByVal Nuevo As Boolean)
            ...
            If Nuevo = True AndAlso objBss.ValidarEstadoTransferencia(intRegion, intPenal) = False Then
                Exit Sub
            End If
        ...
        Public Sub Frm_PadinDetalle()
            ...
            If Me.GrillaVersionPadin = 6 Then 'Ultima version
...
#Region "Eventos"
        ...
        End Sub
        Private Sub rdbPendiente_CheckedChanged(sender As System.Object, e As System.EventArgs) Handles rdbPendiente.CheckedChanged,
                                   rdbProcesado.CheckedChanged, rdbEnvSdCentral.CheckedChanged, rdbTodos.CheckedChanged
