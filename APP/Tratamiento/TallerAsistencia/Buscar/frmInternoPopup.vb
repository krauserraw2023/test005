...
#Region "Propiedades_Otros"
        ...
        Public Property _VisibleRegionPenal() As Boolean
            ...
            End Set
        End Property
        Public Property _VisibleHoraEntrada() As Boolean = False
        Public Property _VisibleHoraSalida() As Boolean = False
#End Region
#Region "Functions"
        ...
        Private Function ValidarBusqueda() As Boolean
            ...
            If Me.CodigoRP.Trim = "" And Me.NumeroDocumento.Trim = "" And Me.Apellidos.Trim = "" And Me.Nombres.Trim = "" Then
...
#Region "Otros"
        ...
        Private Sub ValoresxDefault()
            If Me._VisibleHoraEntrada = True Then
                Timer2.Start()
            End If
            If Me._VisibleHoraSalida = True Then
                Timer2.Start()
            End If
            gbEstado.Visible = Me._VisibleRegionPenal
...
#End Region
 ...
 _
        ...
        Private Sub frmInternoPopup_MouseDown(sender As Object, e As System.Windows.Forms.MouseEventArgs) Handles Me.MouseDown

        End Sub

        Private Sub frmInternoPopup_ResizeBegin(sender As Object, e As System.EventArgs) Handles Me.ResizeBegin
