...
#Region "Propiedades_Interno"
        ...
        Public InternoApePaternoAso As String = ""
        Public InternoApeMaternoAso As String = ""
        Public InternoNombresAso As String = ""
...
#Region "Propiedades_RegionPenal"
        Private Property idRegion() As Short = 3 'region lima
...
#Region "Combo"
        ...
        Public Sub ComboNumIngresoInpe()
            ...
            objEntIngresoInpeCol = (New Bussines.Registro.IngresoInpe).ListarNroIngreso(Me.idInterno)
...
#Region "Validar"
        Public Sub ValidarDuplicadosIngreso()
            ...
            objEntCol = (New Bussines.Registro.IngresoInpe).ListarNroIngreso(Me.idInterno)
...
#Region "Listar"
        Private Sub ListarCodigoRP()
            ...
            Dim objEnt As Entity.Registro.Interno = (New Bussines.Registro.Interno).Listar_LM(Me.idInterno)
        ...
        Private Sub ListarDataInterno(objEnt As Entity.Registro.Interno, Optional ValidarIDInterno As Boolean = True)
            ...
            With objEnt
                ...
                If Not objEntIngresoINPE Is Nothing Then
                    Me._Historico = objEntIngresoINPE.Historico
                    Me._HistoricoFecha = objEntIngresoINPE.HistoricoFecha
                End If
                '/*region y penal*/
                If ValidarIDInterno = True Then
        ...
        End Sub
        Private objEntIngresoINPE As Entity.Registro.IngresoInpe
        Private Sub ListarData()
            ...
            objEntIngresoINPE = (New Bussines.Registro.IngresoInpe).ListarUltimoIngresoInpe(Me.idInterno, -1)
            ...
            If objEntIngresoINPE Is Nothing Then 'cargar los datos de la tabla interno
                ...
                Else
                    ...
                    Me.UscAuditUser1.LoadAudit(Me.idInterno, EnumTipTabla.INT_Interno)
                End If
            Else
                ...
                objEnInternoHisto = objBssHistorico.ListarUltimoHistorico_region_lm(Me.idInterno, Me._IDIngresoINPE)
        ...
        Private Sub ListarInternoHistorico(objEnt As Entity.Registro.InternoHistorico)
            ...
            If Me.idInterno < 1 Or Me._IDIngresoINPE < 1 Then Exit Sub
            ...
            With objEnt
                ...
                Me.UscGradosAcademicos1._PenalId = Me.idPenal
                Me.UscGradosAcademicos1._RegionId = Me.idRegion
                Me.UscGradosAcademicos1._InternoId = Me.idInterno
                ...
                Me.UscIdiomaInterno1._PenalId = Me.idPenal
                Me.UscIdiomaInterno1._RegionId = Me.idRegion
                Me.UscIdiomaInterno1._InternoId = Me.idInterno
                ...
                Me.UscDomicilio1._PenalId = Me.idPenal
                Me.UscDomicilio1._RegionId = Me.idRegion
                Me.UscDomicilio1._InternoId = Me.idInterno
        ...
        Private Sub listarGrillaConstanciaReclusion()
            ...
            With UscInternoDetalle1
                ._loadUsc(Configuracion.Licencia.Codigo,
                          Me.idInterno, Me._IDIngresoINPE, -1, Me.idRegion, Me.idPenal, Me.CodigoRPInterno, Me.InternoApeyNom, Me.regionNombre, Me.penalNombre)
            End With
        ...
        Private Sub Listar_Expedientes()
            ...
            If Me._IDIngresoINPE < 1 Or Me.idInterno < 1 Then Exit Sub
        ...
        Private Sub LoadArchivoDigital()
            With UscVisorArchDigital1
                ._InternoApePaterno = IIf(Me.InternoApePaternoAso.Length = 0, Me.InternoApePaterno, Me.InternoApePaternoAso)
                ._InternoApeMaterno = IIf(Me.InternoApeMaternoAso.Length = 0, Me.InternoApeMaterno, Me.InternoApeMaternoAso)
                ._InternoNombres = IIf(Me.InternoNombresAso.Length = 0, Me.InternoNombres, Me.InternoNombresAso)
                ._InternoId = Me.idInterno
                .LoadUsc()
            End With
        End Sub
...
#Region "Accion"
        Private Function ValidarFotografia() As Integer
            ...
            Dim intCodigo As Integer = objBssFoto.ListarIDFotoReciente(idInterno)
        ...
        Private Function ValidaInternoActivo() As Boolean
            ...
            If Me.CabeceraEstado = "INACTIVO" Then
                ...
                If Me.idPenal = -1 Then 'registros de internos realizados solo x region lima
                    Return value
                Else
                    value = False
                End If
        ...
        Private Sub AGrabarInterno()
            ...
            If Me.idInterno = -1 And Me.idRegion = 3 And Me.idPenal Then
        ...
        Private Sub AEliminarInterno()
            ...
            ent.InternoID = Me.idInterno
            If ((New Bussines.Registro.InternoMovimiento).ListarGrilla_LM(ent).Count) > 0 Then
                strMensaje = strMensaje + " Movimientos activos."
                Legolas.Configuration.Aplication.MessageBox.Exclamation(strMensaje)
                Exit Sub
            End If
            Dim CantidadDoc As Integer = (New Bussines.Registro.DocumentoJudicial).CantidadDocumentosExpedientes_LM(Me.idInterno)
            ...
            objIngresoInp.InternoID = Me.idInterno
            ...
            If Legolas.Configuration.Aplication.MessageBox.QuestionEliminar(strMensaje) = Windows.Forms.DialogResult.Yes Then
                ...
                Value = objBss.Eliminar(Me.idInterno, "")
                If Value > 0 Then
                    Me.idInterno = -1
                    Me.Close()
                End If
...
#Region "Expediente"
        ...
        Private Sub FRM_MantDelito(ByVal Nuevo As Boolean, ByVal IngresoCodigo As Integer, ByVal ExpedienteCodigo As Integer, ByVal DelitoCodigo As Integer)
            ...
            If Me.idInterno < 1 Or Me._IDIngresoINPE < 1 Or ExpedienteCodigo < 1 Then
                Legolas.Configuration.Aplication.MessageBox.Exclamation(
        ...
        Private Sub FRM_MantAgraviado(ByVal Nuevo As Boolean, ByVal IngresoCodigo As Integer, ByVal ExpedienteCodigo As Integer, ByVal DelitoCodigo As Integer, ByVal AgraviadoCodigo As Integer)
            ...
            If Me.idInterno < 1 Or Me._IDIngresoINPE < 1 Or ExpedienteCodigo < 1 Or DelitoCodigo < 1 Then
...
#Region "Resoluciones"
        Private Sub FRM_ListadoExpediente()
            Dim frm As New Registro.Resoluciones.frmVerExpePorResolPopup(_IDIngresoINPE, idInterno)
            frm._TipoLicencia = enmTipoLicencia.RegionLimaMetropolitana
            frm.ShowDialog()
        End Sub

        Private Sub FRM_Modificar_Resolucion(TipoResolucion As System.Int32, IDDocumentoJudicial As System.Int32, SubTipo As Integer, Version As System.String)
            ...
            Select Case TipoResolucion
                ...
                Case enumTipoDocumentoJudicial.OrdenTraslado_HospitalMental_Nota
                    FRM_OrdenTraslado_Nota(IDDocumentoJudicial)
                    ListarCabecera()
...
#Region "Sentencias"
        Private Sub FRM_Resol_Sentencia(DocJudicialId As Integer, Version As String)
            If Version = "V2" Then
        ...
        Private Sub FRM_OrdenTraslado(DocJudicialId As Integer)
            ...
            End With
        End Sub
        Private Sub FRM_OrdenTraslado_Nota(DocJudicialId As Integer)
            ...
            With frm
                ...
                ._Documento_sin_mov = True
                ._TipoLicencia = Type.Enumeracion.Licencia.enmTipoLicencia.RegionLimaMetropolitana
                ._TipoResolucion = Type.Enumeracion.TipoDocJudicial.enumTipoDocumentoJudicial.OrdenTraslado_HospitalMental_Nota
                'permisos
                ._FormEscritura = False
                ._FormEliminar = False
                ._FormReporte = False
...
#Region "Movimientos"
        ...
        Private Sub FRM_TrasladoHospitalmental(MovimientoID As Integer, MovimientoTipoID As Integer, MovimientoMotivoID As Integer,
            ...
            With frm
                ...
                'permisos
                ._FormEscritura = False ' Me._FormEscrituraOriginal
                ._FormEliminar = False ' Me._FormEliminarOriginal
                ._FormReporte = Me._FormReporte
                If .ShowDialog() = Windows.Forms.DialogResult.OK Then
                    Me.UscMovimiento1._Listar()
                    ListarCabecera()
...
#Region "Reniec"
        Private Sub Nuevo_Validacion_Reniec()
            ...
            entIngreso = (New Bussines.Registro.IngresoInpe).ListarUltimoIngresoInpe(Me.idInterno, -1)
...
#End Region
        ...
        Private Sub UscResolucionesMain1__Click_BtnModificarResolucion(TipoDocumento As System.Int32, DocJudicialId As System.Int32, SubTipo As System.Int32, _penid As System.Int32, Version As System.String) Handles UscResolucionesMain1._Click_BtnModificarResolucion
            FRM_Modificar_Resolucion(TipoDocumento, DocJudicialId, SubTipo, Version)
        End Sub
        ...
        Private Sub frmMant_v2_KeyUp(sender As Object, e As KeyEventArgs) Handles Me.KeyUp
