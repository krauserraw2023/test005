...
#Region "Propiedades_Grilla"
                    ...
                    Select Case Me.tcBusqueda.SelectedTab.Name
                        ...
                        Case Me.tpConsultaMovimiento.Name
                            If UscBusquedaMovimiento1._GrillaCount > 0 Then
                                value = UscBusquedaMovimiento1._IDInternoSelect
                            End If

                        Case Me.tpConstanciaReclu.Name
        ...
        Private ReadOnly Property GrillaNombresCompleto() As String
            Get
                Dim value As String = ""
                Try
                    Select Case tcBusqueda.SelectedTab.Name

                        Case tpConsultaInterno.Name
                            With Me.dgwGrilla
                                value = Me.GrillaApellidos & ", " & Me.GrillaNombres
                            End With

                        Case tpConsultaMovimiento.Name
                            If UscBusquedaMovimiento1._GrillaCount > 0 Then
                                value = UscBusquedaMovimiento1._NombresCompletoSelect
                            End If
                    End Select
        ...
        Private ReadOnly Property GrillaPenalID() As Integer
            Get
                ...
                Try
                    Select Case tcBusqueda.SelectedTab.Name
                        ...
                        Case tpConsultaMovimiento.Name
                            If UscBusquedaMovimiento1._GrillaCount > 0 Then
                                value = UscBusquedaMovimiento1._PenIdSelect
                            End If
            ...
            End Get
        End Property
        Private ReadOnly Property GrillaApePaternoAsociado() As String
            Get
                Dim strValue As String = ""
                Try
                    With Me.dgwGrilla
                        strValue = .SelectedRows(0).Cells("col_ape_pat").Value
                    End With
                Catch ex As Exception
            ...
            End Get
        End Property
        Private ReadOnly Property GrillaApeMaternoAsociado() As String
            Get
                Dim strValue As String = ""
                Try
                    With Me.dgwGrilla
                        strValue = .SelectedRows(0).Cells("col_ape_mat").Value
                    End With
                Catch ex As Exception
...
#Region "Propiedades_Buscar"
        ...
        Private ReadOnly Property idPenal() As Short
            ...
            End Get
        End Property
        Private Property penalNombre() As String = "ORL"
...
#Region "Listar"
        ...
        Private Sub listarUscTramiteConstanciaReclusion()
            ...
            Me.UscConsultaTramite1._loadUsc(Configuracion.Licencia.Codigo, True)
            ...
            Select Case Me.IDLicencia
                Case 1 'sede central
                    ...
                    Select Case Me.UsuarioPerfil
                        ...
                        Case Else
                            Me.tcBusqueda.TabPages.Remove(Me.tpAntecedente)
                    End Select
...
#Region "Form"
        Private Sub frmVerReporteConstanciaReclu()

            Dim frm As New Registro.ConstanciaReclusion.frmReporte(Configuracion.Licencia.Codigo, True)
            With frm
                .ShowDialog()
            End With

        End Sub
        Private Sub FRM_MantenimientoV2(ByVal nuevo As Boolean, idInterno As Integer, idPenal As Integer)
            ...
            Dim frm As New Registro.RegionLima.Busqueda.frmMant_v2(idInterno, idRegion, idPenal, regionNombre, penalNombre)
            frm.InternoApePaternoAso = Me.GrillaApePaternoAsociado
            frm.InternoApeMaternoAso = Me.GrillaApeMaternoAsociado
            frm.InternoNombresAso = Me.GrillaNombres
        ...
        Private Sub frmCRTramiteModificar(idTramite As Integer)
            ...
            Dim frm As New Registro.ConstanciaReclusion.frmTramite(idTramite, Type.Enumeracion.Licencia.enmTipoLicencia.RegionLimaMetropolitana)
...
#End Region
        ...
        Private Sub tsbBuscar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsbBuscar.Click
            ...
            Select Case tcBusqueda.SelectedTab.Name
                ...
                Case tpConstanciaReclu.Name
                    Me.UscConsultaTramite1._buscar()
                    Me.NumeroReg = Me.UscConsultaTramite1._count

                Case tpAntecedente.Name
        ...
        Private Sub btnModificar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnModificar.Click
            ...
            ElseIf tcBusqueda.SelectedTab.Name = tpConsultaMovimiento.Name Then
            ...
            Select Case tcBusqueda.SelectedTab.Name
                Case tpConsultaInterno.Name, tpConsultaMovimiento.Name
                    modifInterno = True
        ...
        Private Sub UscBusquedaMovimiento1__Grilla_CellDoubleClick() Handles UscBusquedaMovimiento1._Grilla_CellDoubleClick
            ...
            FRM_MantenimientoV2(False, Me.GrillaInternoID, -1)
        ...
        Private Sub btnNuevoCAJ_Click(sender As System.Object, e As System.EventArgs) Handles btnNuevo.Click
            ...
            Select Case Me.tcBusqueda.SelectedTab.Name
                ...
                Case Me.tpConsultaInterno.Name, Me.tpConsultaMovimiento.Name
                    ...
                    FRM_MantenimientoV2(True, -1, idPenal)
        ...
        Private Sub tcConsultaInternoMovimientos_SelectedIndexChanged(sender As System.Object, e As System.EventArgs) Handles tcBusqueda.SelectedIndexChanged

            Dim verLeyendaAntecedentes As Boolean = False
            Dim verLibroInterno As Boolean = False
            Dim verResumenInterno As Boolean = False

            Select Case Me.tcBusqueda.SelectedTab.Name

                Case Me.tpConsultaInterno.Name
                    verResumenInterno = True
                    verLibroInterno = True
                    Me.pnlNuevo.Visible = Me._FormEscritura
                    Me.pnlBotonModificar.Visible = Me._FormEscritura
                    Me.pnlAnular.Visible = False
                    Me.pnlBotonReporte.Visible = Me._FormReporte
                    Me.NumeroReg = dgwGrilla.Rows.Count
                    Me.txtApePat.Focus()
                ...
                Case Me.tpConsultaMovimiento.Name
                    ...
                    Me.pnlBotonModificar.Visible = False
                    Me.pnlAnular.Visible = False
                    Me.NumeroReg = UscBusquedaMovimiento1._GrillaCount
                    Me.UscBusquedaMovimiento1._Focus()

                Case Me.tpAntecedente.Name
                    verLeyendaAntecedentes = True
                    Me.pnlAnular.Visible = blnEscritura
                    Me.pnlNuevo.Visible = blnEscritura
                    BuscarCAJ()
            ...
            Me.pblLeyenda.Visible = verLeyendaAntecedentes
            Me.btnVerLibros.Visible = verLibroInterno
            Me.pnlResumen.Visible = verResumenInterno
        ...
        Private Sub frmBuscar_v2_DoubleClick(sender As Object, e As EventArgs) Handles Me.DoubleClick
