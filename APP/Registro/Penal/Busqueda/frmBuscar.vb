...
#Region "Propiedades_Grilla"
        Private ReadOnly Property GrillaInternoID() As Integer
            Get
                ...
                Try
                    If tbcSeccion.SelectedTab.Name = "tpConsultaInterno" Then
                        With Me.dgwGrilla
                            intValue = .SelectedRows(0).Cells("col_int_id").Value
                        End With
                    ElseIf tbcSeccion.SelectedTab.Name = "tpConsultaMovimiento" Then

                        intValue = Me.UscBusquedaMovimiento1._IDInternoSelect
        ...
        Private ReadOnly Property GrillaPenalID() As Integer
            Get
                ...
                Try
                    ...
                    Select Case Me.tbcSeccion.SelectedTab.Name
                        ...
                        Case "tpConsultaMovimiento"
                            ...
                            intValue = Me.UscBusquedaMovimiento1.GrillaPenalID
...
#Region "Form"
        Private Sub FRM_NuevoInterno()
            ...
            With frm
                ._IDPenal = Me.PenalID ' 35 'carceleta
                ._IDRegion = Me.RegionID  ''region lima
            ...
            If blnOK = True Then
                Me.InternoRegion = Me.RegionID 'region lima
                Me.InternoRegionNombre = cbbRegion.Text
                Me.InternoPenal = Me.PenalID  'carcelta
                Me.InternoPenalNombre = cbbPenal.Text
                ...
                If f3.ShowDialog = Windows.Forms.DialogResult.OK Then
                    Select Case f3._tipoAccion
                        Case Registro.Main.Carceleta.frmBuscaReniecPopup.enmAccion.NUEVO_INTERNO_DESDE_RENIEC
                            FRM_Mantenimiento(False, f3._IdInterno, Me.PenalID)
...
#Region "Usuario/Permisos"
        Private Sub UsuarioPermisos(ByRef blnCerrarForm As Boolean)
            ...
            If blnElimnarTab = True Then
                Me.tbcSeccion.TabPages.Remove(Me.tpConsultaMovimiento)
                Me.tbcSeccion.TabPages.Remove(Me.tpEmisionAntec)
            ...
            Me.tbcSeccion.TabPages.Remove(Me.tpEmisionAntec) 'temporal hasta hacer el pase a produccion
...
#End Region
        ...
        Private Sub dgwGrilla_CellDoubleClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgwGrilla.CellDoubleClick
            ...
            If Me.dgwGrilla.RowCount > 0 And e.RowIndex <> -1 Then
                FRM_Mantenimiento(False, Me.GrillaInternoID, Me.GrillaPenalID)
            End If
        ...
        Private Sub tcConsultaInternoMovimientos_SelectedIndexChanged(sender As Object, e As EventArgs) Handles tbcSeccion.SelectedIndexChanged

            Dim blnOcultarAnular As Boolean = False
            ...
            Select Case Me.tbcSeccion.SelectedTab.Name
                ...
                Case Me.tpEmisionAntec.Name
                    blnOcultarAnular = True
                    strBotonReporte = "Im&primir"
                    blnVerLeyendaEmiAntece = True
            End Select

            Me.pnlAnular.Visible = blnOcultarAnular
