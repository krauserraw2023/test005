...
#Region "Listar"
        ...
        Private Sub ListarCabecera()
            ...
            objEntInt = objBssInterno.Listar_v6(Me.idInterno)
        ...
        Private Sub ListarCodigoRP()
            ...
            objEnt = objBssInterno.Listar_v6(Me.idInterno)
                ...
                Else
                    ...
                    Else
                        If objEnInternoHisto.Codigo < 1 Then
                            ...
                            'objEntInternoFiltro.Codigo = Me.InternoID
                            objEntInterno = objBssInterno.Listar_v5(Me.idInterno)
                            ListarDataInterno(objEntInterno)
                        Else
                            ListarInternoHistorico(objEnInternoHisto)
                        End If
        ...
        Private Sub LoadUscOdontograma()
            ...
            With UscOdont
                ._loadUsc(Me.idInterno, -1, Me._IDIngreso, Me.idRegion, Me.idPenal, False)
            End With
        ...
        Private Sub listarGrillaConstanciaReclusion()
            ...
            With UscInternoDetalle1
                ._loadUsc(Configuracion.Licencia.Codigo,
                          Me.idInterno, -1, Me._IDIngreso, Me.idRegion, Me.idPenal, Me.CodigoRPInterno, Me.InternoApeyNom, Me.regionNombre, Me.penalNombre)
            End With
...
#Region "Listar_UserControl_Clasificacion"
        ...
        Private Sub ListarClasificacionRegimen()
            ...
            With Me.UscFichaClasificacion1
                ...
                ._uscFichaTab = APPControls.Tratamiento.Asistencia.Clasificacion.Penal.uscFichaClasificacion.enmFichaTab.enmRegimen
                ._ListarUsc()
            End With
        ...
        Private Sub ListarClasificacionEtapa()
            ...
            With Me.UscFichaClasificacion2
                ...
                'permisos
                ._uscPerfilUsuario = Legolas.Configuration.Usuario.OficinaID
                ._uscFichaTab = APPControls.Tratamiento.Asistencia.Clasificacion.Penal.uscFichaClasificacion.enmFichaTab.enmEtapa
                ._ListarUsc()
            End With
...
#Region "Accion"
        ...
        Private Sub AEliminarInterno()
            ...
            objIngreso.InternoID = Me.idInterno
            If ((New Bussines.Registro.Ingreso).ListarNroIngreso(Me.idInterno, Me.idPenal).Count) > 0 Then
        ...
        Private Sub FRM_ListaIngreso()
            ...
            With frm
                ...
                If frm.ShowDialog = DialogResult.OK Then
                    ...
                    If tbcDatosInternos.SelectedTab.Name = tbpReniec.Name Then
                        ...
                        Else
                            DataValidarReniec()
                        End If
                    ElseIf tbcDatosInternos.SelectedTab.Name = tbpAlias.Name Then
                        UscAlias21._Load()
                    ElseIf TabControl3.SelectedTab.Name = tbpListaExpedientes.Name Then
                        UscMandatoDetencion.IngresoID = Me.cbbNroIngresos.SelectedValue
                        UscMandatoDetencion._LoadUsc()
                    ElseIf TabControl3.SelectedTab.Name = tbpMovimientos.Name Then
                    ...
                    EntInt.InternoID = Me.idInterno
                    EntInt.PenalID = Me.idPenal
...
#Region "Expediente"
        Private Sub FRM_MantExpediente(ByVal Nuevo As Boolean, ByVal IngresoCodigo As Integer, ByVal ExpedienteCodigo As Integer)
            ...
            If Me.idInterno < 1 Or IngresoCodigo < 1 Then
...
#Region "Clasificacion"
        ...
        End Sub
        Private Sub FRM_ReporteClasificacion(intIDInternoFichaFinal As Integer, objFichaTab As uscFichaClasificacion.enmFichaTab)
            ...
            With frm
                ...
                Select Case objFichaTab
                    Case uscFichaClasificacion.enmFichaTab.enmRegimen
                        ._TipoReporte = Type.Reporte.Tratamiento.Trabajo.TallerAsistencia.rpt_ClasificacionRegimen

                    Case uscFichaClasificacion.enmFichaTab.enmEtapa
...
#Region "Reniec"
        Private Sub Nuevo_Validacion_Reniec()
            ...
            entIngreso = objBssIngreso.ListarUltimoIngreso(Me.idInterno)
...
#End Region
        ...
        Private Sub UscResolucionesMain1__Click_ModificarResolucion(TipoResolucion As System.Int32, DocJudicialId As System.Int32, SubTipo As System.Int32) Handles UscResolucionesMain1._Click_BtnModificarResolucion
        ...
        Private Sub btnActivar_Click(sender As System.Object, e As System.EventArgs)
            ...
            Else
                If Legolas.Configuration.Aplication.MessageBox.QuestionGrabar("Esta seguro de actualizar el estado del interno a estado ACTIVO") = DialogResult.Yes Then
                    objBssInterno = New Bussines.Registro.Interno
                    objBssInterno.ActivarEstado(Me.idInterno)
        ...
        Private Sub btnInactivar_Click_1(sender As Object, e As EventArgs) Handles btnInactivar.Click
            ...
            Else
                ...
                If MessageBox.Show("Esta seguro de actualizar el estado del interno a estado INACTIVO", strTitulo, MessageBoxButtons.YesNo,
                    ...
                    objBssInterno = New Bussines.Registro.Interno
                    objBssInterno.ActualizarEstadoBaja(Me.idInterno)
        ...
        Private Sub UscFichaClasificacion1__GrillaFichaVariable_CellClick(objEnt As Entity.Tratamiento.Asistencia.Clasificacion.Penal.DatosFicha) Handles UscFichaClasificacion1._GrillaFichaVariable_CellClick
        ...
        Private Sub UscFichaClasificacion2__GrillaFichaVariable_CellClick(objEnt As Entity.Tratamiento.Asistencia.Clasificacion.Penal.DatosFicha) Handles UscFichaClasificacion2._GrillaFichaVariable_CellClick

            FRM_ClasificacionIndicadores(2, objEnt)

        End Sub

        Private Sub UscFichaClasificacion1__GrillaFicha_CellEnter(intCodigo As Integer, TipoTablaAudit As Enumeracion.Auditoria.EnumTipTabla) Handles UscFichaClasificacion1._GrillaFicha_CellEnter
        ...
        Private Sub UscFichaClasificacion1__Reporte_Click(intIDInternoFichaFinal As Integer, objFichaTab As uscFichaClasificacion.enmFichaTab) Handles UscFichaClasificacion1._Reporte_Click

            FRM_ReporteClasificacion(intIDInternoFichaFinal, objFichaTab)

        End Sub

        Private Sub UscFichaClasificacion2__Reporte_Click(intIDInternoFichaFinal As Integer, objFichaTab As uscFichaClasificacion.enmFichaTab) Handles UscFichaClasificacion2._Reporte_Click
        ...
        Private Sub UscInternoDetalle1_Load(sender As Object, e As EventArgs) Handles UscInternoDetalle1.Load
