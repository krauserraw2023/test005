...
#Region "Propiedades_Interno"
        ...
        Private _HistoricoFecha As Long = 0
#End Region
...
#Region "Listar"
        ...
        Private Sub LoadUscOdontograma()
            ...
            With UscOdont
                ...
                ._InternoId = Me.idInterno
                ._IngresoID = Me._IDIngreso
                .TipoLicencia = enmTipoLicencia.PenalProvincia
                ._RegionId = Me.idRegion
                ._PenalId = Me.idPenal
                ._LoadUsc()
            End With
            ...
            Using DB As New DataContextDataContext(Legolas.Configuration.Data.ConexionIni)
                ...
                UscOdotoNew1.CodIngresoInpe = -1 '_IDIngresoINPE
                UscOdotoNew1.PenalId = Me.idPenal
                UscOdotoNew1.RegionId = Me.idRegion
                UscOdotoNew1.SoloLectura = IIf(Legolas.Configuration.Usuario.OficinaID = 1 Or Legolas.Configuration.Usuario.OficinaID = 11 Or Legolas.Configuration.Usuario.OficinaID = 31, False, True)
...
#Region "Resoluciones"
        ...
        End Sub
        Private Sub FRM_Resolucion_Sentencia(TipoResolucion As System.Int32, IDDocumentoJudicial As System.Int32, SubTipo As Integer, Version As System.String)
            ...
            Select Case SubTipo
                Case enumSubTipo.ProyeccionVencimientoCondena
                    ...
                    With frm
                        ...
                        ._TipoLicencia = Type.Enumeracion.Licencia.enmTipoLicencia.PenalProvincia
                        'permisos
                        ._FormEscritura = blnEscrituraRegistro ' Me._FormEscritura
                        ._FormEliminar = Me._FormEliminar
                        ._FormReporte = Me._FormReporte
                        If .ShowDialog() = Windows.Forms.DialogResult.OK Then
                            ListarResoluciones()
...
#Region "Sentencias"
        ...
        Private Sub FRM_Resol_SentenciaMultiple(DocJudicialId As Integer, TipoResolucion As Integer)
            ...
            '    End With
            'Else
            If TipoResolucion = Type.Enumeracion.TipoDocJudicial.enumTipoDocumentoJudicial.Sent_Pena_Limitativa Then
...
#End Region
        ...
        Private Sub UscResolucionesMain1__Click_ModificarResolucion(TipoResolucion As System.Int32, DocJudicialId As System.Int32, SubTipo As System.Int32, Version As System.String) Handles UscResolucionesMain1._Click_BtnModificarResolucion
            ...
            FRM_Resolucion_Sentencia(TipoResolucion, DocJudicialId, SubTipo, Version)
