Imports APPControls.Registro.Resoluciones

Namespace Registro.Resoluciones
    Public Class frmOtrosprocesos
...
#Region "accion"
        ...
        Private Function AGrabar() As Integer
            ...
            With obDocJud
                .DocumentoTipo = IIf(Me._TipoFormulario = 73, 73, Type.Enumeracion.TipoDocJudicial.enumTipoDocumentoJudicial.Ingreso)
                ...
                Select Case uscResolIngreso._MovimientoMotivo
                    ...
                    Case Type.Enumeracion.Movimiento.EnumMovMotivo.IngresoSentencia,
                         ...
                         Type.Enumeracion.Movimiento.EnumMovMotivo.Adelanto_de_fallo
                        .SentenciaCadenaPerpetua = UscExpeDeResolucionIng1.Cadenaperpetua
            ...
            If Me._Codigo = -2 Then
                Return -2
            End If
            UscExpeDeResolucionIng1._Grabar(Me._Codigo, Me._blnNuevoRegistro, Type.Enumeracion.TipoDocJudicial.enumTipoDocumentoJudicial.Ingreso, uscResolIngreso._MovimientoMotivo)
...
#Region "Forms"
        Private Sub FRM_Grilla()
            If uscResolIngreso._MovimientoMotivo < 1 Then
                Legolas.Configuration.Aplication.MessageBox.Exclamation("Selecionar el motivo del proceso.")
                Exit Sub
            End If
            Dim blnNuevoExpediente As Boolean = False
            Select Case uscResolIngreso._MovimientoMotivo
                Case 116, 117, 120, 189
                    ...
                    With frm
                        ...
                        ._MotivoIngreso = uscResolIngreso._MovimientoMotivo
                        ...
                        If .ShowDialog = Windows.Forms.DialogResult.OK Then
                            ...
                            Else
                                If .objEntExpedienteTempoCol.Count = 0 And (._MotivoIngreso = 116 Or ._MotivoIngreso = 117 Or ._MotivoIngreso = 120 Or ._MotivoIngreso = 189) Then
                                    Legolas.Configuration.Aplication.MessageBox.Exclamation("No existen procesos pendientes por revocatoria de libertad")
                                    Exit Sub
                                End If
                            End If
                        End If
                    ...
                    If blnNuevoExpediente = True Then
                        ...
                        With frm2
                            ...
                            End If
                        End With
                        UscExpeDeResolucionIng1.ActualizarDatosTipoInimputable(uscResolIngreso._MovimientoMotivo, -1)
                    End If
                Case Else
                    Dim frm2 As New Expediente.v5.frmExpedientePopup3
                    With frm2
...
#Region "otros"
        ...
        Private Sub ValoresxDefault()
            With uscResolIngreso
                ...
                .DocumentoTipo = Me._TipoFormulario
                ._LoadUsc()
                UscAuditUser1.LoadAudit(._Codigo, Type.Enumeracion.TipoTabla.EnumTipTabla.REG_DOC_Judicial)
            End With
            Me.UscMovimientoDetalle21.Visible = False

            With UscPeriodoDetencion1
                ._DocumentoTipo = Type.Enumeracion.TipoDocJudicial.enumTipoDocumentoJudicial.OtroProceso
                ._LoadUsc()
            ...
            With UscExpeDeResolucionIng1
                ...
                .Cadenaperpetua = uscResolIngreso.Cadenaperpetua
                .TotalAnios = uscResolIngreso.TotalAnios
                .TotalMeses = uscResolIngreso.TotalMeses
                .TotalDias = uscResolIngreso.TotalDias
                ._FormEscritura = Me._FormEscritura
                ._FormEliminar = Me._FormEliminar
                .PeriodoCondenaVisible(Type.Enumeracion.TipoDocJudicial.enumTipoDocumentoJudicial.Ingreso, uscResolIngreso._MovimientoMotivo)
...
#End Region
        ...
        Private Sub btnAceptar_Click(sender As System.Object, e As System.EventArgs) Handles btnAceptar.Click
            If uscResolIngreso.Validar = True Then
                If Me._Documento_sin_mov = True Then
                    ...
                    End If
                Else
                    If UscPeriodoDetencion1.Validar(uscResolIngreso._MovimientoMotivo) = True Then
                        If UscExpeDeResolucionIng1.Validar(Me._DocumentoSubtipo, Me.uscResolIngreso._MovimientoMotivo) = True Then
                            If Legolas.Configuration.Aplication.MessageBox.QuestionGrabar(UscExpeDeResolucionIng1.strMensaje) = DialogResult.Yes Then
                                If AGrabar() > -1 Then
                                    Me.DialogResult = Windows.Forms.DialogResult.OK
                                    Me.Close()
        ...
        Private Sub UscMovimientoDetalle21_clicK_MostrarControles(MotivoId As Integer, uscVisible As Boolean, menuVisible As Boolean) Handles UscMovimientoDetalle21.clicK_MostrarControlesAux
            ...
            UscPeriodoDetencion1.ConfigurarUscPrisionPreventiva()
        ...
        Private Sub UscInimputables1__click_MostrarPeriodocondena(blnValor As Boolean)
            ...
            End If
        End Sub
        Dim intMotivoId As Integer = -1
        Private Sub uscResolIngreso__MostrarControles(MotivoId As Integer, uscVisible As Boolean, menuVisible As Boolean) Handles uscResolIngreso._MostrarControles
            Select Case MotivoId
                Case -1
                    UscExpeDeResolucionIng1.LimpiarGrillas()
                Case 116, 117, 189, 122
                    If MotivoId <> intMotivoId Then
                        UscExpeDeResolucionIng1.LimpiarGrillas()
                    End If
                Case Else '100
                    Select Case intMotivoId
                        Case -1, 116, 117, 189, 122
                            UscExpeDeResolucionIng1.LimpiarGrillas()
                    End Select
            End Select
            Select Case MotivoId
                ...
                Case Type.Enumeracion.Movimiento.EnumMovMotivo.IngresoSentencia
                    Me._DocumentoSubtipo = Type.Enumeracion.SubTipoDocJudicial.enumSubTipo.IngresoSentencia
                Case 188
                    Me._DocumentoSubtipo = 103 ' Type.Enumeracion.SubTipoDocJudicial.enumSubTipo.Adelanto_de_Fallo
                Case Else
                    Me._DocumentoSubtipo = -1
                    Me._Subtipo = -1
            End Select
            ...
            uscResolIngreso.CargarEiquetasTraslado(Me._DocumentoSubtipo)
            UscExpeDeResolucionIng1.Visible = True
            intMotivoId = MotivoId
        End Sub

        Private Sub frmOtrosprocesos_Load(sender As Object, e As EventArgs) Handles MyBase.Load
