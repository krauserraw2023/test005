...
Namespace Registro.Sentencias
    Public Class frmResolSentenciaV2
#Region "Propiedades"
...
#Region "Accion"
        Private Function AGrabar() As Integer
            ...
            End With
            With UscDeclaraConsentida1
                EntDocJud.SentenciaConsentida = .DeclaraConsentida
                EntDocJud.DocumentoNumeroTraslado = .NumeroResolucion
                EntDocJud.FechaResolucion = .FechaResolucion
                EntDocJud.FechaRecepcionResolucion = .FechaRecepcionResolucion
            End With
            EntDocJud._Version = "V2"
            EntDocJud = uscResolSentencia.AGrabarV3(EntDocJud, _blnNuevoRegistro)

            If EntDocJud.Codigo < 1 Then Return EntDocJud.Codigo
            'Grabar periodo de sentencia 
            EntDocJud.SituacionJuridicaId = UscDeclaraConsentida1.SituacionJuridicaId
                ...
                If .ShowDialog = Windows.Forms.DialogResult.OK Then
                    ...
                    If blnNuevoExpediente = False Then
                        ...
                        If idMotivoIngreso = Type.Enumeracion.Movimiento.EnumMovMotivo.Inimputable Or
                            ...
                            End With
                        ElseIf .objEntExpedienteTempoCol.Item(0).DocumentoTipoID = Type.Enumeracion.TipoDocJudicial.enumTipoDocumentoJudicial.OtroProceso Then
                            uscResolSentencia.blnCadenaPerpetua = .objEntExpedienteTempoCol.Item(0).SentenciaCadenaPerpetua
                            usrDetalleRegSent._TotalAnhos = .objEntExpedienteTempoCol.Item(0).SentenciaAnio
                            usrDetalleRegSent._TotalMes = .objEntExpedienteTempoCol.Item(0).SentenciaMes
                            usrDetalleRegSent._TotalDias = .objEntExpedienteTempoCol.Item(0).SentenciaDia
...
#Region "Otros"
        Private Sub ValoresxDefault()
            ...
            End With
            With UscDeclaraConsentida1
                ._Load(uscResolSentencia.objEnt, usrDetalleRegSent._ExpedienteReferenciado)
            End With
        End Sub
...
#End Region
        ...
        Private Sub btnAceptar_Click(sender As System.Object, e As System.EventArgs) Handles btnAceptar.Click
            If uscResolSentencia.Validar = True Then
                If usrDetalleRegSent.Validar = True Then
                    If UscDeclaraConsentida1.Validar(usrDetalleRegSent.strMensaje) = True Then
                        Dim strMensaje As String = usrDetalleRegSent.strMensaje
                        If strMensaje.Length > 0 Then
                            strMensaje = strMensaje + Chr(13) + "de todas maneras..." + Chr(13) + " " + Chr(13) + "Desea guardar los datos."
                        End If
        ...
        End Sub
        Private Sub UscDeclaraConsentida1__Click_FechaRecepcion() Handles UscDeclaraConsentida1._Click_FechaRecepcion
            UscDeclaraConsentida1.FechaRecepcionResolucion = uscResolSentencia.DocumentoFechaRecepcion
        End Sub

        Private Sub uscResolSentencia__Click_FechaRecepcion() Handles uscResolSentencia._Click_FechaRecepcion
            UscDeclaraConsentida1.FechaRecepcionResolucion = uscResolSentencia.DocumentoFechaRecepcion
        End Sub
    End Class
