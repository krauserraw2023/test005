Namespace Registro.PenaLM.Clasificacion
...
#Region "Property"
        ...
        Public Property Switch As Boolean = False
...
#Region "LISTAR"
        Private Sub ListarValores()
            ...
            Dim objCol As New Entity.Registro.Carceleta.Clasificacion.MaestroIndicadorCol_BE

            dgvValores.DataSource = bssFich.ListarClas(entVar)
            dgvValores.AutoSizeRowsMode = DataGridViewAutoSizeRowsMode.AllCells
            'txtPtje.Text = 0


            Dim c() As Color = {Color.FromArgb(219, 243, 252), Color.FromArgb(199, 249, 238), Color.FromArgb(217, 252, 204), Color.FromArgb(255, 255, 192),
                                Color.FromArgb(255, 242, 196), Color.FromArgb(255, 226, 227), Color.FromArgb(255, 255, 242), Color.FromArgb(199, 255, 100)}
...
#End Region
        ...
        Private Sub dgvValores_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgvValores.CellContentClick
