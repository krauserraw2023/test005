                ...
                Try
                    Select Case Me.tcBusqueda.SelectedTab.Name
                        ...
                        Case Me.tpBandeja.Name
                            value = dgwBandeja.SelectedRows(0).Cells("bnd_col_int_id").Value
...
#Region "Listar"
        ...
        Private Sub ShowFotografia()
            ...
            If tcBusqueda.SelectedTab.Name = tpBandeja.Name Then
...
#Region "Accion"
        ...
        Private Sub CargarBandejaPendiente(Optional mostrarAlertarPopup As Boolean = True)
            ...
            Dim t As DataTable
            t = ws.ListaPendRecepTraslado(Me.idPenal)
...
#Region "Form"
        Private Sub frmCRTramiteNuevo(idInterno As Integer)
            ...
            Dim frm As New Registro.ConstanciaReclusion.frmTramite(-1, Me.InternoID, idRegion, idPenal,
                Me.GrillaInternoCodigo, Me.grillaInternoApeNom, Me.GrillaRegionNombre, Me.GrillaPenalNombre, abrirForm,
        ...
        Private Sub frmCRTramiteModificar(idTramite As Integer)
            ...
            Dim frm As New Registro.ConstanciaReclusion.frmTramite(idTramite, Type.Enumeracion.Licencia.enmTipoLicencia.PenalLimaMetropolitana)
            frm._FormEscritura = Me._FormEscritura
            frm._FormEliminar = Me._FormEliminar
            frm._FormReporte = Me._FormReporte
            frm._verDetalleInterno = True
        ...
        End Sub
        'Private Sub FRM_Mantenimiento(ByVal Nuevo As Boolean, idInterno As Integer, idPenal As Short)

        '    If Legolas.Configuration.Usuario.Login = "USR0023" Then
        '        FRM_MantenimientoV2(Nuevo, idInterno, idPenal)
        '        Exit Sub
        '    End If
        ...
        Private Sub ANuevo()
            ...
            f._IDPenal = Me.idPenal
            f._IDRegion = Me.idRegion
            ...
            If ok = True Then
                ...
                Select Case f._TipoAccion
                    Case frmBuscaIntSedeCentralPopup.enmTipoAccion.REGISTRO_MANUAL
                        FRM_MantenimientoV2(True, -1, Me.idPenal)

                    Case frmBuscaIntSedeCentralPopup.enmTipoAccion.REGISTRO_EXISTENTE

                        Dim idInterno As Integer = f._IDInternoSelecionado
                        If idInterno > 0 Then
                            FRM_MantenimientoV2(False, idInterno, Me.idPenal)
                        End If
        ...
        Private Sub FRM_MantenimientoV2(ByVal nuevo As Boolean, idInterno As Integer, idPenal As Integer)
            ...
            Dim frm As New Registro.PenalLM.Busqueda.frmMant_v2(idInterno, idRegion, idPenal, regionNombre, penalNombre)
            frm.MdiParent = Me.MdiParent
            With frm
                'permisos
                ._FormLectura = Me._FormLectura
        ...
        Private Sub RecibirDatosBasicosInterno()
            ...
            'validar el servicio de archivo digital
            If (New Bussines.Globall.ArchivoDigital).TestServicioArchivoDigital(True) = False Then

                mensaje = "No se encuentra disponible el servicio " & APPWebService.PathURL.WSPopeSedeCentral & " de la Sede Central, " &
            ...
            mensaje = "Se va a recepcionar y registrar la información del interno seleccionado, desea continuar?"

            If Legolas.Configuration.Aplication.MessageBox.Question(mensaje) <> DialogResult.Yes Then Exit Sub

            Try

                Me.nRegionId_hilo = Me.idRegion
                Me.nPenalId_hilo = Me.idPenal
                ...
                '*****************/
                FRM_MantenimientoV2(False, Me.n_interno_id, Me.idPenal)
...
#End Region
        ...
        Private Sub tcConsultaInternoMovimientos_SelectedIndexChanged(sender As Object, e As System.EventArgs) Handles tcBusqueda.SelectedIndexChanged
