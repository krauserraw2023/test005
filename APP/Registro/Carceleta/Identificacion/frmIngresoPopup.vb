...
#Region "Listar"
        Private Sub ListarData()
            ...
            With objEnt
                ...
                Me.FechaMovIngresoEP = .FechaMovimientoIngreso

                Dim dteFechaIng As Date = Now
                dteFechaIng = Legolas.Components.FechaHora.FechaDate(.FechaMovimientoIngreso, True)
        ...
        Private Sub ListarGrilla()
            ...
            With Me.dgwIngreso
                ...
                .DataSource = objEntInpCol ' IIf(Me._IngresoInpe = True, objEntInpCol, objEntCol)
            End With
...
#Region "Validar"
        Private Function ValidarDatos() As Boolean
            ...
            If Me.FechaISP > Now.ToFileTime Then
                MessageBox.Show("La fecha ISP no puede ser futura, verifique", _
            ...
            If Me.FechaMovIngresoEP > Now.ToFileTime Then
                MessageBox.Show("La fecha de movimiento de ingreso no puede ser futura.", _
                Legolas.Configuration.Aplication.MessageBox.MensajeTitulo, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                Me.NumericUpDown1.Focus()
                Return value
            End If
            ...
            If Me.FechaMovIngresoEP < 1 Then
                MessageBox.Show("Ingrese fecha de ingreso.", _
                Legolas.Configuration.Aplication.MessageBox.MensajeTitulo, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
...
#Region "Accion"
        Private Function AGrabar() As Boolean
            ...
            If objEntCol.Count > 0 Then
                ...
                objMovimiento = (New Bussines.Registro.InternoMovimiento).Listar_LM(objMovimiento)
            ...
            If idIngPen > 0 And movIngNuevo = True Then
                ...
                If Me.Codigo < 1 Then
                    ...
                    'faltaaaaaaaaaaaa--->
                    intValueHis = objBssHis.Grabar_HistoricoCopia_LM(Me._IDInterno, lngIDIngreso, intValue, idIngPen, Me._IDRegion, Me._IDPenal)
                End If
                blnGrabarOK = True
        ...
        Private Function AGrabarMovimiento(objEnt As Entity.Registro.InternoMovimiento, idIngresoInpe As Integer, IDIngreso As Long) As Long
            ...
            With objEnt
                ...
                .MovimientoMotivoID = Me.IDMovimientoMotivo
        ...
        Private Sub AEliminarIngresoInpe()
            ...
            If Legolas.Configuration.Aplication.MessageBox.Question(strPregunta) = DialogResult.Yes Then
                ...
                value = objBssInp.Eliminar(Me.GrillaIDIngresoINPE)
                If value > 0 Then Me.DialogResult = Windows.Forms.DialogResult.OK
            End If
