...
#Region "Propiedades"
        Public InternoID As Integer = -1
        Public Fecha As Long = 0
...
#End Region
    End Class
#Region "AsistenciaCol"
    Public Class AsistenciaCol
        ...
        Public Sub Sort(ByVal sortExpression As String)
            ...
            End If
        End Sub
        Public Function Add(ByVal obj As Asistencia) As Integer
            Return MyBase.List.Add(obj)
        End Function
        Public ReadOnly Property Rasgos(ByVal Index As Integer) As Asistencia
            Get
                Return CType(MyBase.List(Index), Asistencia)
            End Get
        End Property
    End Class
#End Region
