...
#Region "Propiedades_CaracteristicasNotables"
        ...
        Private objEntColAsistencia As Entity.Reporte.Tratamiento.AsistenciaCol = Nothing
        Public Property AsistenciaCol() As Reporte.Tratamiento.AsistenciaCol
            Get
                Return objEntColAsistencia
            End Get
            Set(ByVal value As Reporte.Tratamiento.AsistenciaCol)
                objEntColAsistencia = value
            End Set
        End Property
#End Region
...
#Region "DatosUltimoInternamiento"
        ...
        Public Property LicenciaPenalNombre As String = ""
        Public Property LicenciaRegionNombre As String = ""
