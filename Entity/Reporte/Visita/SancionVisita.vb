...
#End Region
    End Class
#Region "SancionVisitaCol"
    Public Class SancionVisitaCol
        ...
        Public Sub Sort(ByVal sortExpression As String)
            ...
            End If
        End Sub
        Public Function Add(ByVal obj As SancionVisita) As Integer
            Return MyBase.List.Add(obj)
        End Function
        Public ReadOnly Property SancionVisita(ByVal Index As Integer) As SancionVisita
            Get
                Return CType(MyBase.List(Index), SancionVisita)
            End Get
        End Property
        Public Function CloneCol() As SancionVisita
