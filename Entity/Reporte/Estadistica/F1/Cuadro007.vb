Namespace Reporte.Estadistica.F1
    Public Class Cuadro007
#Region "Propiedades"
        Private strTiempoReclucion As String = ""
        ...
        Public Property TiempoReclucion() As String
            Get
                Return strTiempoReclucion
            End Get
            Set(ByVal value As String)
                strTiempoReclucion = value
            End Set
        End Property
...
#Region "Cuadro007Col"
    Public Class Cuadro007Col
        ...
        Public Sub Sort(ByVal sortExpression As String)
            ...
            End If
        End Sub
        Public Function Add(ByVal obj As Cuadro007) As Integer
            Return MyBase.List.Add(obj)
        End Function
        Public ReadOnly Property Cuadro007(ByVal Index As Integer) As Cuadro007
            Get
                Return CType(MyBase.List(Index), Cuadro007)
            End Get
        End Property
    End Class
#End Region
