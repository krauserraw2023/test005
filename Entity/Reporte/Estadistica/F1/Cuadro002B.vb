...
#End Region
    End Class
#Region "Cuadro002BCol"
    Public Class Cuadro002BCol
        ...
        Public Sub Sort(ByVal sortExpression As String)
            ...
            End If
        End Sub
        Public Function Add(ByVal obj As Cuadro002B) As Integer
            Return MyBase.List.Add(obj)
        End Function
        Public ReadOnly Property Cuadro002B(ByVal Index As Integer) As Cuadro002B
            Get
                Return CType(MyBase.List(Index), Cuadro002B)
            End Get
        End Property
    End Class
#End Region
