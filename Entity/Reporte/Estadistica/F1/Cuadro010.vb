...
#Region "Cuadro010Col"
    Public Class Cuadro010Col
        ...
        Public Sub Sort(ByVal sortExpression As String)
            ...
            End If
        End Sub
        Public Function Add(ByVal obj As Cuadro010) As Integer
            Return MyBase.List.Add(obj)
        End Function
        Public ReadOnly Property Cuadro010(ByVal Index As Integer) As Cuadro010
            Get
                Return CType(MyBase.List(Index), Cuadro010)
            End Get
        End Property
    End Class
#End Region
