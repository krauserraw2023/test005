...
#Region "Propiedades"
        ...
        Private intCalendario As Integer = -1
        ...
        Public Property Codigo() As Integer
            ...
            End Set
        End Property
        Public Property CalendarioId() As Integer
            Get
...
#Region "CalendarioCol"
    Public Class CalendarioDetalleCol
        ...
        Public Sub Sort(ByVal sortExpression As String)
            ...
            End If
        End Sub
        Public Function Add(ByVal obj As CalendarioDetalle) As Integer
            Return MyBase.List.Add(obj)
        End Function
        Public ReadOnly Property Calendario(ByVal Index As Integer) As CalendarioDetalle
            Get
                Return CType(MyBase.List(Index), CalendarioDetalle)
            End Get
        End Property
