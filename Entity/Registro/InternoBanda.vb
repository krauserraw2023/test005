...
#Region "Propiedades"
        ...
        Public Property IngresoInpeNro As Integer = 0
...
#Region "BandaCol"
    Public Class InternoBandaCol
        ...
        Public Sub Sort(ByVal sortExpression As String)
            ...
            End If
        End Sub
        Public Function Add(ByVal obj As InternoBanda) As Integer
            Return MyBase.List.Add(obj)
        End Function
        Public ReadOnly Property InternoBanda(ByVal Index As Integer) As InternoBanda
            Get
                Return CType(MyBase.List(Index), InternoBanda)
            End Get
        End Property
    End Class
#End Region
