...
#Region "Propiedades_InternoInimputable"
...
#End Region
    End Class
#Region "InternoInimputableCol"
    Public Class InternoInimputableCol
        ...
        Public Sub Sort(ByVal sortExpression As String)
            ...
            End If
        End Sub
        Public ReadOnly Property Item(ByVal Index As Integer) As InternoInimputable
            Get
                If Index < 0 Then
                    Return Nothing
                End If
                Try
                    Return CType(MyBase.List(Index), InternoInimputable)
            ...
            End Get
        End Property
        Public Function Add(ByVal obj As InternoInimputable) As Integer
            Return MyBase.List.Add(obj)
        End Function
        Public ReadOnly Property Expediente(ByVal Index As Integer) As InternoInimputable
            Get
                If Index < 0 Then
                    Return Nothing
                End If
