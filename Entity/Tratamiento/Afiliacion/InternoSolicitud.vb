        ...
        Public ReadOnly Property ObservacionRegistro As String
            Get
                ...
                If Me.ApellidoPaterno.Length > 0 And Me.ApellidoMaterno.Length > 0 And Me.Nombres.Length > 0 And _
                   Me.TipoDocumentoID = 10 And NumeroDocumento.Length = 8 And Me.FechaNacimiento > 0 And Me.SexoID > -1 And
                   (Me.TipoMovimientoID > 0 And Me.TipoMovimientoNom.Length > 0) Then
                    Value = ""
                End If
                Return Value
            End Get
        ...
        Public ReadOnly Property TipoMovimientoNom() As String
            Get
                ...
                If TipoMovimientoID = Type.Enumeracion.Movimiento.EnumMovTipo.Libertad Then
                    ...
                    Nombre = "LIBERTAD"
                ElseIf TipoMovimientoID = Type.Enumeracion.Movimiento.EnumMovTipo.Internamiento And Me.FechaIngreso > 0 Then
            ...
            End Get
        End Property
        Public ReadOnly Property FechaMovimiento() As Long
            Get
                Dim Value As Long = 0
               
                If TipoMovimientoID = Type.Enumeracion.Movimiento.EnumMovTipo.Libertad Then
                    Value = Me.FechaLibertad
                ElseIf TipoMovimientoID = Type.Enumeracion.Movimiento.EnumMovTipo.Internamiento Then
                    Value = Me.FechaIngreso
                ElseIf TipoMovimientoID = Type.Enumeracion.Movimiento.EnumMovTipo.Traslado Then
                    Value = Me.FechaLibertad
                End If
                Return Value
...
#End Region
    End Class
#Region "InternoCol"
    Public Class InternoSolicitudCol
