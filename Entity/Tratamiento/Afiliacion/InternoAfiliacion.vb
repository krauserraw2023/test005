...
#End Region
    End Class
#Region "InternoCol"
    Public Class InternoAfiliacionCol
        ...
        Public Sub Sort(ByVal sortExpression As String)
            ...
            End If
        End Sub
        Public Function Add(ByVal value As InternoAfiliacion) As Integer
            Return List.Add(value)
        End Function
        Public Function Contains(ByVal value As InternoAfiliacion) As Boolean
            Return List.Contains(value)
        End Function
        Public Function IndexOf(ByVal value As InternoAfiliacion) As Integer
            Return List.IndexOf(value)
        End Function
        Public Sub Insert(ByVal index As Integer, ByVal value As InternoAfiliacion)
            List.Insert(index, value)
        End Sub
        Default Public Property Item(ByVal index As Integer) As InternoAfiliacion
            Get
                Return DirectCast(List(index), InternoAfiliacion)
            End Get
            Set(ByVal value As InternoAfiliacion)
                List(index) = value
            End Set
        End Property
        Public Sub Remove(ByVal value As InternoAfiliacion)
            List.Remove(value)
        End Sub
        Public Function CloneCol() As InternoAfiliacion
            Return MyBase.MemberwiseClone
        End Function
        Public Function toList() As List(Of InternoAfiliacion)
            Dim a As New List(Of InternoAfiliacion)
            For Each i As InternoAfiliacion In InnerList
                a.Add(i)
            Next
            Return a
        End Function
