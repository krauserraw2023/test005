...
Namespace Registro
    Public Class DocumentoJudicial
        Private Shared strNameProcedure As String = "UP_REG_DOC_Judicial"
#Region "Listar"
        Public Shared Function ListarOutput(ByVal accion As String, ByVal opcion As String, ByVal Codigo As Integer) As Integer
            Try
        ...
        Public Shared Function ListarOutput(ByVal accion As String, ByVal opcion As String,
                                            EntDoc As Entity.Registro.DocumentoJudicial) As Integer
            Try
                Dim intValue As Integer = -1
                Using sqlCon As SqlConnection = New SqlConnection(Legolas.Configuration.Data.ConexionIni)
                    Using sqlCmd As SqlCommand = New SqlCommand(strNameProcedure, sqlCon)
                        With sqlCmd
                            ...
                            .Parameters.Add(New SqlParameter("@accion", SqlDbType.VarChar, 3)).Value = accion
                            .Parameters.Add(New SqlParameter("@opcion", SqlDbType.VarChar, 120)).Value = opcion
                            .Parameters.Add(New SqlParameter("@int_id", SqlDbType.Int)).Value = EntDoc.InternoId
                            .Parameters.Add(New SqlParameter("@int_ing_id", SqlDbType.Int)).Value = EntDoc.InternoIngresoId
                            .Parameters.Add(New SqlParameter("@doc_tip_id", SqlDbType.Int)).Value = EntDoc.DocumentoTipo
                            .Parameters.Add(New SqlParameter("@doc_jud_num", SqlDbType.VarChar, 120)).Value = EntDoc.DocumentoNumero
                            .Parameters.Add(New SqlParameter("@doc_jud_fec", SqlDbType.BigInt)).Value = EntDoc.DocumentoFecha

                            .Parameters.Add(New SqlParameter("@f_reg_doc_jud_fec_int", SqlDbType.BigInt)).Value = EntDoc.FechaInternamientoPenalOrigen
                            .Parameters.Add(New SqlParameter("@f_reg_doc_jud_fec_ing", SqlDbType.BigInt)).Value = EntDoc.FechaIngresoPenalOrigen
                            .Parameters.Add(New SqlParameter("@c_reg_doc_jud_obs", SqlDbType.VarChar, 2500)).Value = EntDoc.ObservacionPenalOrigen
                            .Parameters.Add(New SqlParameter("@_penid", SqlDbType.Int)).Value = EntDoc._PenalID
                ...
                Using sqlCon As SqlConnection = New SqlConnection(Legolas.Configuration.Data.ConexionIni)
                    Using sqlCmd As SqlCommand = New SqlCommand(strNameProcedure, sqlCon)
                        With sqlCmd
                            ...
                            .Parameters.Add(New SqlParameter("@int_id", SqlDbType.Int)).Value = EntDoc.InternoId
                            .Parameters.Add(New SqlParameter("@int_ing_id", SqlDbType.Int)).Value = EntDoc.InternoIngresoId
                            .Parameters.Add(New SqlParameter("@fk_ing_inp_id", SqlDbType.Int)).Value = EntDoc.IngresoInpeId
                            .Parameters.Add(New SqlParameter("@doc_tip_id", SqlDbType.Int)).Value = EntDoc.DocumentoTipo
                            .Parameters.Add(New SqlParameter("@doc_jud_num", SqlDbType.VarChar, 120)).Value = EntDoc.DocumentoNumero

                            .Parameters.Add(New SqlParameter("@c_reg_doc_jud_doc", SqlDbType.VarChar, 250)).Value = EntDoc.DocumentoJudicialPenalOrigen
                            .Parameters.Add(New SqlParameter("@f_reg_doc_jud_fec_int", SqlDbType.BigInt)).Value = EntDoc.FechaInternamientoPenalOrigen
                            .Parameters.Add(New SqlParameter("@f_reg_doc_jud_fec_ing", SqlDbType.BigInt)).Value = EntDoc.FechaIngresoPenalOrigen
                            .Parameters.Add(New SqlParameter("@c_reg_doc_jud_obs", SqlDbType.VarChar, 2500)).Value = EntDoc.ObservacionPenalOrigen
        ...
        Public Shared Function Listar(ByVal sqlCon As SqlConnection, ByVal accion As String, ByVal opcion As String, ByVal Codigo As Integer) As SqlDataReader
        ...
        Public Shared Function Listar2(ByVal sqlCon As SqlConnection, ByVal accion As String, ByVal opcion As String,
            ...
            Try
                ...
                With sqlCmd
                    ...
                    .Parameters.Add(New SqlParameter("@fk_doc_jud_id_anu", SqlDbType.Int)).Value = objDocJud.IdDocumentoAntecedente
                End With
...
#Region "Grabar"
                ...
                Using sqlCon As SqlConnection = New SqlConnection(Legolas.Configuration.Data.ConexionIni)
                    Using sqlCmd As SqlCommand = New SqlCommand(strNameProcedure, sqlCon)
                        With sqlCmd
                            ...
                            .Parameters.Add(New SqlParameter("@fk_doc_jud_id_anu", SqlDbType.Int)).Value = objEnt.IdDocumentoAntecedente
                            ...
                            .Parameters.Add(New SqlParameter("@est_eje_trs_id", SqlDbType.Int)).Value = objEnt.EstadoEjecucionId
                            .Parameters.Add(New SqlParameter("@sen_fec_ins", SqlDbType.BigInt)).Value = objEnt.FechaInscripcion
                            .Parameters.Add(New SqlParameter("@_sent_fresol", SqlDbType.BigInt)).Value = objEnt.FechaResolucion
                            .Parameters.Add(New SqlParameter("@_sent_frecp", SqlDbType.BigInt)).Value = objEnt.FechaRecepcionResolucion
                            .Parameters.Add(New SqlParameter("@_sent_vers", SqlDbType.VarChar, 3)).Value = objEnt._Version
        ...
        Public Shared Function Grabar(ByVal accion As String, ByVal opcion As String, objEnt As Entity.Registro.DocumentoJudicial) As Integer
            ...
            End Try
        End Function
        Public Shared Function GrabarQuedaJud(ByVal accion As String, ByVal opcion As String, objEnt As Entity.Registro.DocumentoJudicial) As Integer
            Try
                Dim intCodigo As Integer = -1
                Using sqlCon As SqlConnection = New SqlConnection(Legolas.Configuration.Data.ConexionIni)
                    Using sqlCmd As SqlCommand = New SqlCommand(strNameProcedure, sqlCon)
                        With sqlCmd
                            ...
                            .Parameters.Add(New SqlParameter("@_regid", SqlDbType.Int)).Value = objEnt._RegionID
                            .Parameters.Add(New SqlParameter("@_penID", SqlDbType.Int)).Value = objEnt._PenalID
                            .Parameters.Add(New SqlParameter("@_sed_flg_trf", SqlDbType.TinyInt)).Value = objEnt.Proceso_Pendiente_Queda
                            .Parameters.Add(New SqlParameter("@doc_jud_obs", SqlDbType.VarChar, 500)).Value = objEnt.Observacion_Queda
                            '.Parameters.Add(New SqlParameter("@doc_jud_fec_rec", SqlDbType.BigInt)).Value = objEnt.DocumentoFechaRecepcion
                            '.Parameters.Add(New SqlParameter("@doc_jud_fec", SqlDbType.BigInt)).Value = objEnt.DocumentoFecha
                            '.Parameters.Add(New SqlParameter("@tip_aut_jud_id", SqlDbType.Int)).Value = objEnt.TipoAutoridadJudicial
                            '.Parameters.Add(New SqlParameter("@dis_jud_id", SqlDbType.Int)).Value = objEnt.DistritoJudicial
            ...
            End Try
        End Function
        Public Shared Function GrabarV3(ByVal accion As String, ByVal opcion As String, objEnt As Entity.Registro.DocumentoJudicial) As Integer
...
#Region "Elininar"
        ...
        Public Shared Function Eliminar(ByVal accion As String, ByVal opcion As String,
            ...
            End Try
        End Function
        Public Shared Function Eliminar_x_Queda(ByVal accion As String, ByVal opcion As String,
                                         ByVal Codigo As Integer, InternoID As Integer, IngresoID As Integer, FlagTransferenciaSede As Integer) As Integer
            Try
                Dim intCodigo As Integer = -1
                Using sqlCon As SqlConnection = New SqlConnection(Legolas.Configuration.Data.ConexionIni)
        ...
        Public Shared Function Listar(ByVal sqlCon As SqlConnection, accion As String, opcion As String,
            ...
            Try
                ...
                With sqlCmd
                    ...
                    .Parameters.Add(New SqlParameter("@fk_doc_jud_id_anu", SqlDbType.Int)).Value = objEntity.IdDocumentoAntecedente
                    .Parameters.Add(New SqlParameter("@doc_jud_est_id", SqlDbType.Int)).Value = objEntity.Estado
                    .Parameters.Add(New SqlParameter("@est_eje_trs_id", SqlDbType.Int)).Value = objEntity.EstadoEjecucionId
                End With
                sqlDr = sqlCmd.ExecuteReader(CommandBehavior.CloseConnection)
            Catch ex As SqlException
                Throw New Exception(ex.Message)
