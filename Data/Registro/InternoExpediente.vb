...
Namespace Registro
    Public Class Expediente
        Private Shared strNameProcedure As String = "UP_INT_InternoExpediente"
#Region "Listar"
        Public Shared Function ListarOutput(ByVal accion As String, ByVal opcion As String, ByVal Codigo As Integer,
               ...
               ByVal SalaJudicialId As Integer,
               ByVal ExpedienteNumero As String,
               ByVal ExpedienteFecha As Long,
               ByVal SituacionJuridicaId As Integer, ByVal FechaLibertad As Long) As Integer
            Try
        ...
        Optional ByVal RegistroVisible As Integer = -1
        ) As SqlDataReader
        ...
        Public Shared Function Listar(ByVal sqlCon As SqlConnection, ByVal accion As String, ByVal opcion As String, objIntExp As Entity.Registro.Expediente) As SqlDataReader
            ...
            Try
                ...
                With sqlCmd
                    ...
                    .Parameters.Add(New SqlParameter("@doc_tip_cat", SqlDbType.SmallInt)).Value = objIntExp.DocumentoTipoCategoria
                    .Parameters.Add(New SqlParameter("@n_int_exp_mot_id", SqlDbType.SmallInt)).Value = objIntExp.MotivoIngresoID
                End With
                sqlReader = sqlCmd.ExecuteReader(CommandBehavior.CloseConnection)
            Catch ex As SqlException
                Throw New Exception(ex.Message)
...
#Region "Grabar"
    ...
    RegionID As Integer, PenalID As Integer, ByVal Estado As Integer, ByVal Usuario As Integer) As Integer
        ...
        Public Shared Function GrabarSubtipoLibertad(ByVal accion As String, ByVal opcion As String, objIntExp As Entity.Registro.Expediente) As Integer
...
#Region "reg_doc_jucial_expediente"
        ...
        Public Shared Function Listar(ByVal sqlCon As SqlConnection, ByVal accion As String, ByVal opcion As String,
                                      objEntity As Entity.Registro.Documento.DocumentoJudicialExpediente) As SqlDataReader
            ...
            Try
                ...
                With sqlCmd
                    ...
                    .Parameters.Add(New SqlParameter("@accion", SqlDbType.VarChar, 3)).Value = accion
                    .Parameters.Add(New SqlParameter("@opcion", SqlDbType.VarChar, 120)).Value = opcion
                    .Parameters.Add(New SqlParameter("@int_exp_id", SqlDbType.Int)).Value = objEntity.IDExpediente
                    .Parameters.Add(New SqlParameter("@int_id", SqlDbType.Int)).Value = objEntity.InternoId
                    .Parameters.Add(New SqlParameter("@int_ing_id", SqlDbType.Int)).Value = objEntity.IDIngreso
                    .Parameters.Add(New SqlParameter("@crea_doc_jud_id", SqlDbType.Int)).Value = objEntity.DocJudicialId
