...
Namespace Registro
    Public Class AlertaSentenciaCabecera
        Private Shared strNameProcedure As String = "usp_rep_cab_notificacion_sentencia"
#Region "Listar"

        Public Shared Function Listar(ByVal sqlCon As SqlConnection, ByVal accion As String, ByVal opcion As String,
                                       ByVal objDocJud As Entity.Registro.AlertaSentenciaCabecera) As SqlDataReader

            Dim objEntCol As Entity.Registro.AlertaSentenciaCabeceraCol = Nothing
            Dim objEnt As Entity.Registro.AlertaSentenciaCabecera = Nothing
