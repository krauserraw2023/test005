...
Namespace Mantenimiento.General
    Public Class Ambiente_DA
        Private Shared strNameProcedure As String = "usp_int_mov_ambiente"

        Public Shared Function Listar(ByVal sqlCon As SqlConnection, ByVal accion As String, ByVal opcion As String,
                              objEnt As Ambiente_BE) As SqlDataReader
            ...
            Try
                ...
                With sqlCmd
                    ...
                    .Parameters.Add(New SqlParameter("@pk_ambiente_id", SqlDbType.Int)).Value = objEnt.Codigo
                    ...
                    .Parameters.Add(New SqlParameter("@amb_habilitado", SqlDbType.Bit)).Value = objEnt.AmbienteHabilitado
        ...
        Public Shared Function Grabar(ByVal accion As String, ByVal opcion As String,
                              ByVal objEnt As Ambiente_BE) As Integer
                ...
                Using sqlCon As SqlConnection = New SqlConnection(Legolas.Configuration.Data.ConexionIni)
                    Using sqlCmd As SqlCommand = New SqlCommand(strNameProcedure, sqlCon)
                        With sqlCmd
                            ...
                            .Parameters.Add(New SqlParameter("@pk_ambiente_id", SqlDbType.Int)).Value = objEnt.Codigo
                            .Parameters.Add(New SqlParameter("@fk_alero_id", SqlDbType.Int)).Value = objEnt.AleroId
                            .Parameters.Add(New SqlParameter("@c_nombre", SqlDbType.VarChar, 100)).Value = objEnt.AmbienteNombre
                            .Parameters.Add(New SqlParameter("@amb_habilitado", SqlDbType.Bit)).Value = objEnt.AmbienteHabilitado
                ...
                Using sqlCon As SqlConnection = New SqlConnection(Legolas.Configuration.Data.ConexionIni)
                    Using sqlCmd As SqlCommand = New SqlCommand(strNameProcedure, sqlCon)
                        With sqlCmd
                            ...
                            .Parameters.Add(New SqlParameter("@accion", SqlDbType.VarChar, 3)).Value = accion
                            .Parameters.Add(New SqlParameter("@opcion", SqlDbType.VarChar, 120)).Value = opcion
                            .Parameters.Add(New SqlParameter("@pk_ambiente_id", SqlDbType.Int)).Value = intCodigo
