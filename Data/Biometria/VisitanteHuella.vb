...
Namespace Biometria
    Public Class VisitanteHuella
        Private Shared strNameProcedure As String = "pa_mov_visitante_huella"

        Public Shared Function Listar(ByVal sqlCon As SqlConnection, accion As String, opcion As String, objEnt As Entity.Biometria.VisitanteHuella,
            ...
            Try
                ...
                With sqlCmd
                    ...
                    .Parameters.Add(New SqlParameter("@pk_vis_hue_id", SqlDbType.Int)).Value = objEnt.Codigo
                    .Parameters.Add(New SqlParameter("@kf_vis_id", SqlDbType.Int)).Value = objEnt.IDVisitante
                    .Parameters.Add(New SqlParameter("@kf_hue_ind_izq_id", SqlDbType.Int)).Value = objEnt.IDIndiceIzquierdo
                    .Parameters.Add(New SqlParameter("@kf_hue_pul_izq_id", SqlDbType.Int)).Value = objEnt.IDPulgarIzquierdo
                    .Parameters.Add(New SqlParameter("@kf_hue_ind_der_id", SqlDbType.Int)).Value = objEnt.IDIndiceDerecho
                    .Parameters.Add(New SqlParameter("@kf_hue_pul_der_id", SqlDbType.Int)).Value = objEnt.IDPulgarDerecho
        ...
        Public Shared Function Grabar(accion As String, opcion As String, ByVal objEnt As Entity.Biometria.VisitanteHuella, ByRef out_sms As String) As Integer
            ...
            Try
                ...
                With sqlCmd
                    ...
                    .Parameters.Add(New SqlParameter("@n_vis_hue_tip_cap_izq", SqlDbType.SmallInt)).Value = objEnt.TipoCapturaIzquierdo
                    .Parameters.Add(New SqlParameter("@kf_hue_ind_izq_id", SqlDbType.Int)).Value = objEnt.IDIndiceIzquierdo
                    ...
                    .Parameters.Add(New SqlParameter("@n_vis_hue_tip_cap_der", SqlDbType.SmallInt)).Value = objEnt.TipoCapturaDerecho
                    .Parameters.Add(New SqlParameter("@kf_hue_ind_der_id", SqlDbType.Int)).Value = objEnt.IDIndiceDerecho
