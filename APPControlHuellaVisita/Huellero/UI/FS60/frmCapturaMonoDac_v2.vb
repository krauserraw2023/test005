...
Public Class frmCapturaMonoDac_v2
    ...
    Class ThreadParameters
        ...
        'Public imageDataSeg(512 * 512 - 1) As Byte
    ...
    Sub ConvertWSQ(ByVal threadParam As ThreadParameters)
        ...
        Try
            ...
            Else 'decadactilar
                ...
                'WSQ_Image = m_hDevice.WSQ_FromRawImage(threadParam.imageDataSeg, 512, 512, fBitRate)

                If threadParam.dataSubf(0).err = 0 Then

                    'Array.Copy(threadParam.imageDataSubf, SizeSubf, imagetempSubfBin, 0, threadParam.width * threadParam.height)
                    'WSQ_Image = m_hDevice.WSQ_FromRawImage(imagetempSubfBin, threadParam.dataSubf(0).ws, threadParam.dataSubf(0).hs, fBitRate)

                    Array.Copy(threadParam.imageDataSubf, SizeSubf, imagetempSubfBin, 0, 512 * 512)
                    WSQ_Image = m_hDevice.WSQ_FromRawImage(imagetempSubfBin, 512, 512, fBitRate)
    ...
    Private Function ConectarDispositivo() As Boolean
        ...
        Else
            Try
                ...
                imageSize = threadParams.hDevice.ImageSize
                threadParams.height = 500 ' imageSize.Height
                threadParams.width = 500 'imageSize.Width
                ...
                threadParams.paramSeg.nWidthSubf = 500 'MathNums.xsize
                threadParams.paramSeg.nHeightSubf = 500 'MathNums.ysize
