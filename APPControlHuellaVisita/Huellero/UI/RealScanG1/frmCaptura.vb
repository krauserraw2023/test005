...
Public Class frmCaptura
    ...
    Public Property _AnchoForm As Integer = 488
    Public Property _LargoForm As Integer = 439
...
#Region "Funciones_publicas"
    Public Sub _ReiniciarDispositivo()
        ...
        Me._IniciarDispositivo(Me.enm_TipoDedo, Me.enm_CalidadMinimaHuellaAceptable)
    End Sub
    ...
    Public Function _IniciarDispositivo(tipoDedo As Enumeracion.TipoDedo, calidadMinimaHuellaAceptable As Enumeracion.IndiceCalidadHuella) As Boolean
        ...
        If IniciarSDK() = False Then Return False
        If Iniciar_Dispositivo() = False Then Return False
...
#Region "Eventos"
    Private Delegate Sub RSRawCaptureCallbackInt(ByVal nDeviceHandle As Integer, ByVal nErrorCode As Integer, ByRef pbyImgData As Byte, ByVal nWidth As Integer, ByVal nHeight As Integer)
...
#Region "Funciones_SDK"
    ...
    Private Function IniciarCaptura() As Boolean
        Try
            ...
            If nRetVal = RS_ERR_FINGER_EXIST Then
                MessageBox.Show("Por favor, retire el dedo por un momento o limpie el dispositivo biométrico", "", MessageBoxButtons.OK, MessageBoxIcon.Information)
                Return False
            End If
    ...
    Private Sub VistaPreviaStop()
        ...
        Catch ex As Exception
            ...
            s = s
        End Try
        Me.enm_CalidadMinimaHuellaAceptable = Enumeracion.IndiceCalidadHuella.NoEspecificado 'setear para que al cargar obligue a especificar nuevamente
    End Sub
    ...
    Private Function SaveImage() As Boolean
        ...
        'Dim controlHuella As APPHuella.uscHuellaVisor = VisorHuellaSelect()
        ...
        Else
            b_capturaValida = False
            Me.lblEstado.Text = "La calidad de la huella no está permitida, vuelva ha intentarlo"
        End If
        Return value
    End Function
#End Region
...
#End Region
    ...
    Private Sub frmCaptura_Shown(sender As System.Object, e As System.EventArgs) Handles MyBase.Shown
        ...
        ''/*Metodo actualidado por hugo  19/10/2017*/
        ...
        If IniciarCaptura() = False Then
            System.Threading.Thread.Sleep(1000 * 3) 'esperar 4 segundos para q el usuario pueda tomar acciones
            If IniciarCaptura() = False Then 'segundo intento
    ...
    Private Sub frmCaptura_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        Me.Width = Me._AnchoForm
        Me.Height = Me._LargoForm
        ...
        If Me.b_DispositivoIniciado = False Then
            MessageBox.Show("Debe inicializar el dispositivo y terminar cerrar el dispositivo.", "Captura dactilar", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
            Me.DialogResult = Windows.Forms.DialogResult.Cancel
            Me.Close()
        End If
    ...
    Private Sub frmCaptura_FormClosing(sender As System.Object, e As System.Windows.Forms.FormClosingEventArgs) Handles MyBase.FormClosing
        Try
            VistaPreviaStop()
        Catch ex As Exception
            Me.Close()
