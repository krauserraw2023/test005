...
Namespace Registro
    Public Class AlertaSentenciaCabecera
        Private objEnt As Entity.Registro.AlertaSentenciaCabecera = Nothing
...
#End Region
#Region "Listar"
        Public Function Listar(obj As Entity.Registro.AlertaSentenciaCabecera) As Entity.Registro.AlertaSentenciaCabeceraCol
            Dim accion As String = "lst"
            Dim opcion As String = ""
            Dim entCol As New Entity.Registro.AlertaSentenciaCabeceraCol

            opcion = "lst_aler_sent_cab"

                    entCol = Listar(accion, opcion, obj)
            Return entCol
        End Function
        Public Function Listar(accion As String, opcion As String, objDocJud As Entity.Registro.AlertaSentenciaCabecera) As Entity.Registro.AlertaSentenciaCabeceraCol

            Dim sqlCon As SqlConnection = New SqlConnection(Legolas.Configuration.Data.ConexionIni)
            Dim objEntCol As New Entity.Registro.AlertaSentenciaCabeceraCol
            Dim sqlDr As SqlDataReader = Data.Registro.AlertaSentenciaCabecera.Listar(sqlCon, "lst", opcion, objDocJud)

            Try
                If sqlDr.HasRows Then
                    While sqlDr.Read
                        objEnt = New Entity.Registro.AlertaSentenciaCabecera
                        With objEnt
                            .Codigo = sqlDr("pk_cab_not_sen_id").ToString
                            .Numero = sqlDr("c_num").ToString
                            .Item = sqlDr("n_ite").ToString
                            .Titulo = sqlDr("cab_not_sen_tit").ToString
                            .SentenciasPendientes = sqlDr("cab_not_sen_pend").ToString
                            .SentenciasVencidas = sqlDr("cab_not_sen_venc").ToString
                            .FechaConsulta = sqlDr("cab_not_sen_fec").ToString
                            If sqlDr("cab_not_sen_per_ini").ToString <> "" Then
                                .FechaInicial = sqlDr("cab_not_sen_per_ini").ToString
                            End If
                            If sqlDr("cab_not_sen_per_fin").ToString <> "" Then
                                .FechaFinal = sqlDr("cab_not_sen_per_fin").ToString
                            End If
                            ._PenalID = sqlDr("fk_pen_id").ToString
                            ._RegionID = sqlDr("fk_reg_id").ToString
                        End With
        ...
        'Public Function ListarDetalle(EntDocJud As Entity.Registro.AlertaSentencia) As Entity.Registro.DocumentoJudicialCol
        'Dim sqlCon As SqlConnection = New SqlConnection(Legolas.Configuration.Data.ConexionIni)
        '    Dim sqlDr As SqlDataReader = Data.Registro.AlertaSentencia.Listar2_LM(sqlCon, "lst", "lst_aler_sent_det", EntDocJud)
        '    Dim objEntcol As New Entity.Registro.AlertaSentenciaCol
        ...
        '        If sqlDr.HasRows Then
        '            While sqlDr.Read
        '                objEnt = New Entity.Registro.AlertaSentencia
        '                With objEnt
        ...
        '                    .Delito = sqlDr("fk_del_esp_id").ToString
        ...
        '                    .Estado = sqlDr("n_est_sent").ToString
        ...
        '                        End If
        '                    End If
        '                    .Movimientofecha = sqlDr("mov_fec").ToString
        '                    .DocumentoFecha = sqlDr("doc_jud_fec").ToString
        '                    .DocumentoFechaRecepcion = sqlDr("doc_jud_fec_rec").ToString
        '                    .ProlonDetencionFechIni = sqlDr("prol_det_ini_fec").ToString
        '                    .ProlonDetencionFechFin = sqlDr("prol_det_fin_fec").ToString
        ...
        '                    .Anulacion = sqlDr("n_anu_id").ToString
