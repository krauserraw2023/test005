...
Namespace Registro
    Public Class frmPrintOdontograma_v2
        ...
        Private Sub CargarOdontograma()
            ...
            AxCtlOdon2.Visible = True
            AxCtlOdon3.Visible = True
            AxCtlOdon4.Visible = True
            ...
            Try
                ...
                AxCtlOdon2.OpenOdontograma(dirTmp & "\" & z.Item(0).FileName)
                AxCtlOdon3.OpenOdontograma(dirTmp & "\" & z.Item(0).FileName)
                AxCtlOdon4.OpenOdontograma(dirTmp & "\" & z.Item(0).FileName)
